...
Figure \ref{fig:fee_liability} tells a similar story: Overall, the social costs level is relatively static, with higher liability thresholds producing modest savings controlling for fee-shifting level. Figure \ref{fig:fee_liability} does feature the panel that has the strongest performance at baseline costs of any intervention seen so far: the combination of high fee-shifting with a high liability level. But this is optimal not because it leads to settlements, but because plaintiffs are hesitant to file in truly not liable cases and even in cases in which the defendant is truly liable. As before, relatively low precaution costs in this model appear to minimize the total social cost.
