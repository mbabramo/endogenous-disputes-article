...
In a world of costly litigation, how can procedural mechanisms best advance the cause of the substantive law? This question lies at the heart of much of the law-and-economics literature on issues such as fee shifting, damages multipliers, and burdens of persuasion. Answers, however, have proven elusive. Natural experiments are few and far between, experimental evidence leaves questions about generalizability, and theoretical models generally require unrealistic assumptions. Each of these approaches faces a further obstacle: Even if we can determine how a change in procedural rules may affect the behavior of litigants and thus litigation outcomes such as settlement rates and accuracy, a full welfare analysis demands that we then take the next step of assessing the impact of such changes on primary behavior. Yet changes in primary behavior can also affect litigants' beliefs, producing complicated equilibrium dynamics.

The literature has thus for the most part avoided the challenge of simultaneously modeling both the generation of disputes and the litigation process that resolves them. Models of the tort process may take the litigation system as a given, for example by assuming a fixed cost of litigation cost without fully assessing the dynamics of trial. Shavell (1980)'s canonical comparison of strict liability versus negligence assumes the absence of litigation costs, and even many more modern models, such as Baumann & Rasch (2024)'s model of product liability, entertain a similar assumption. Meanwhile, models of the litigation process itself, such as models of fee shifting, may begin from the assumption that a dispute has occurred, thus ignoring the possibility that a different litigation system might have avoided an accident or other source of controversy. [CITES] That is not to say that there is no overlap. For example, [CITE]. But there is an obvious trade-off in mathematical modeling, with greater attention to detailing of the dispute generation process requiring sacrifices in depicting the dispute resolution process and vice-versa.

An important exception to this generalization has been the work of Keith Hylton. Over a pair of papers, Hylton developed what he called a "cradle to grave" model of litigation. In his models, potential injurers must decide how much to take care, which determines how many accidents occur, and which in turn result in lawsuits in which there might or might not be fee shifting. In Hylton (1990), Hylton (1993) and Hylton (2002), the potential tortfeasor draws a random cost of care and then compares it to the benefit in expected liability savings from compliance, taking into account the risk of type-1 and type-2 errors. The first article does not explicitly model settlement, while the second assumes that cases settle whenever there is a zone of agreement (that is, the plaintiff's minimum acceptable settlement is not greater than the defendant's maximum offer). The third article features a Bayesian settlement model in which plaintiffs play mixed strategies in determining whether to accept defendants' offers.  

To accomplish the remarkable feat of finding equilibria across both care and litigation decisions, Hylton necessarily must make some sacrifices in the realism of the model of litigation, even in his Bayesian model.

The article calculates the sum of compliance, injury and legal costs for particular assumed values of parameters, such as the distribution of the cost of care, and shows that the British rule outperforms alternatives. 
 
the defendant knows whether it complied with the legal standard, while the plaintiff knows only the distribution of liability. . The challenge he addressed was finding equilibria among all these decisions.

--so maybe it's binary decision whether to engage in care
...
\begin{figure}[h!]
\centering
\includegraphics[width=10cm, height=10cm, trim={0in 0in 0in 0in}, clip]{../Figures-old/game tree 2x2x2.pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.25, trim={0in 0in 0in 0in}, clip]{../Figures-old/game tree 2x2x2 beginning.pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.4, trim={0in 0in 0in 0in}, clip]{../Figures-old/liability signals default.pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.25, trim={0in 0in 0in 0in}, clip]{../Figures-old/game tree 2x2x2 end.pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.25, trim={0in 0in 0in 0in}, clip]{../Figures-old/game tree 2x2x2 beginning simplified.pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.25, trim={0in 0in 0in 0in}, clip]{../Figures-old/game tree 2x2x2 end simplified.pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.50, trim={0in 0in 0in 0in}, clip]{../Figures-old/File and answer decisions (American).pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.50, trim={0in 0in 0in 0in}, clip]{../Figures-old/File and answer decisions (British).pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.50, trim={0in 0in 0in 0in}, clip]{../Figures-old/Offers heatmap (American).pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.50, trim={0in 0in 0in 0in}, clip]{../Figures-old/Offers heatmap (British).pdf}
...
\begin{figure}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.98\textwidth, scale=0.70, trim={0in 0in 0in 0in}, clip]{../Figures-old/Source of error costs and expenditures (American)} % first figure itself
        \caption{Errors and expenditures (American)}
		\label{fig:errors_american}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.98\textwidth, scale=0.70, trim={0in 0in 0in 0in}, clip]{../Figures-old/Source of error costs and expenditures (British)} % second figure itself
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.50, trim={0in 0in 0in 0in}, clip]{../Figures-old/Disposition Baseline.pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.50, trim={0in 0in 0in 0in}, clip]{../Figures-old/Accuracy and Expenditures Baseline.pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.40, trim={0in 0in 0in 0in}, clip]{../Figures-old/risk aversion.pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.50, trim={0in 0in 0in 0in}, clip]{../Figures-old/Disposition Varying Risk Aversion.pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.50, trim={0in 0in 0in 0in}, clip]{../Figures-old/Accuracy and Expenditures Varying Risk Aversion.pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.50, trim={0in 0in 0in 0in}, clip]{../Figures-old/Disposition Varying Risk Aversion Asymmetry.pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.50, trim={0in 0in 0in 0in}, clip]{../Figures-old/Accuracy and Expenditures Varying Risk Aversion Asymmetry.pdf}
...
\begin{figure}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.98\textwidth, scale=0.70, trim={0in 0in 0in 0in}, clip]{../Figures-old/Disposition Varying Noise Multiplier} % first figure itself
        \caption{Disposition based on player noise levels}
		\label{fig:dispositions_playernoise}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.98\textwidth, scale=0.70, trim={0in 0in 0in 0in}, clip]{../Figures-old/Accuracy and Expenditures Varying Noise Multiplier} % second figure itself
...
\begin{figure}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.98\textwidth, scale=0.70, trim={0in 0in 0in 0in}, clip]{../Figures-old/Disposition Varying Information Asymmetry} % first figure itself
        \caption{Disposition based on information quality asymmetry}
		\label{fig:dispositions_playernoise_asymmetry}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.98\textwidth, scale=0.70, trim={0in 0in 0in 0in}, clip]{../Figures-old/Accuracy and Expenditures Varying Information Asymmetry} % second figure itself
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.50, trim={0in 0in 0in 0in}, clip]{../Figures-old/Accuracy and Expenditures Varying Case Strength Noise Costs 1.pdf}
...
\begin{figure}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.98\textwidth, scale=0.70, trim={0in 0in 0in 0in}, clip]{../Figures-old/Disposition Varying Relative Costs} % first figure itself
        \caption{Disposition with asymmetric costs}
		\label{fig:dispositions_costsasymmetry}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.98\textwidth, scale=0.70, trim={0in 0in 0in 0in}, clip]{../Figures-old/Accuracy and Expenditures Varying Relative Costs} % second figure itself
...
\begin{figure}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.98\textwidth, scale=0.70, trim={0in 0in 0in 0in}, clip]{../Figures-old/Disposition Varying Proportion of Costs at Beginning} % first figure itself
        \caption{Disposition based on timing of costs}
		\label{fig:dispositions_timing}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.98\textwidth, scale=0.70, trim={0in 0in 0in 0in}, clip]{../Figures-old/Accuracy and Expenditures Varying Proportion of Costs at Beginning} % second figure itself
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.4, trim={0in 0in 0in 0in}, clip]{../Figures-old/damages signals.pdf}
...
\begin{figure}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.98\textwidth, scale=0.70, trim={0in 0in 0in 0in}, clip]{../Figures-old/Disposition Varying Issue} % first figure itself
        \caption{Disposition based on issue in case}
		\label{fig:dispositions_issue}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.98\textwidth, scale=0.70, trim={0in 0in 0in 0in}, clip]{../Figures-old/Accuracy and Expenditures Varying Issue} % second figure itself
...
\begin{figure}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.98\textwidth, scale=0.70, trim={0in 0in 0in 0in}, clip]{../Figures-old/Disposition Varying Fee Shifting Rule (Damages Issue)} % first figure itself
        \caption{Disposition based on fee-shifting rule}
		\label{fig:dispositions_damagesrule}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.98\textwidth, scale=0.70, trim={0in 0in 0in 0in}, clip]{../Figures-old/Accuracy and Expenditures Varying Fee Shifting Rule (Damages Issue)} % second figure itself
...
\begin{figure}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.98\textwidth, scale=0.70, trim={0in 0in 0in 0in}, clip]{../Figures-old/Disposition Varying Quitting Rules} % first figure itself
        \caption{Disposition based on permissibility of quitting}
		\label{fig:dispositions_quit}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.98\textwidth, scale=0.70, trim={0in 0in 0in 0in}, clip]{../Figures-old/Accuracy and Expenditures Varying Quitting Rules} % second figure itself
...
\begin{figure}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[scale=0.5, trim={0in 0in 0in 0in}, clip]{../Figures-old/Baseline multiple equilibria (American).pdf}
		\caption{Coefficient of variation for 29 American rule equilibria}
\label{fig:baseline_multieq_american}
    \end{minipage}\hfill
    \begin{minipage}{0.48\textwidth}
        \centering
		\includegraphics[scale=0.5, trim={0in 0in 0in 0in}, clip]{../Figures-old/Baseline multiple equilibria (British).pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.5, trim={0in 0in 0in 0in}, clip]{../Figures-old/Correlation between correlated and average equilibrium.pdf}
...
\begin{figure}
    ...
    \begin{minipage}{0.24\textwidth}
        \centering
        \includegraphics[scale=0.15, trim={0in 0in 0in 0in}, clip]{../Figures-old/Disposition Baseline.pdf}
		\caption{Risk neutral, large tree}
		\label{fig:treesize_panel1}
    \end{minipage}\hfill
    \begin{minipage}{0.24\textwidth}
        \centering
		\includegraphics[scale=0.15, trim={0in 0in 0in 0in}, clip]{../Figures-old/Disposition Baseline (Small Tree).pdf}
		\caption{Risk neutral, small tree}
		\label{fig:treesize_panel2}
    \end{minipage}
   \begin{minipage}{0.24\textwidth}
        \centering
        \includegraphics[scale=0.15, trim={0in 0in 0in 0in}, clip]{../Figures-old/Disposition (Risk Averse) Baseline.pdf}
		\caption{Risk averse, large tree}
		\label{fig:treesize_panel3}
    \end{minipage}\hfill
    \begin{minipage}{0.24\textwidth}
        \centering
		\includegraphics[scale=0.15, trim={0in 0in 0in 0in}, clip]{../Figures-old/Disposition (Risk Averse) Baseline (Small Tree).pdf}
