...
\begin{abstract}
\begin{nohyphen}
A linear programming algorithm solves extensive-form game trees representing litigation games in which parties receive correlated quality signals. Model permutations allow for asymmetric two-sided information, risk aversion, costs, and information quality, while providing litigants with file, answer, offer, and quit decisions, in cases concerning either damages or liability. With baseline parameters, the British rule has a minimal effect on the chance that a case will be contested at all but often leads to a lower incidence of trial, in contrast to the conventional wisdom. Increasing the cost of litigation generally does not meaningfully change the advisability of fee shifting. 
\end{nohyphen}
\end{abstract}
