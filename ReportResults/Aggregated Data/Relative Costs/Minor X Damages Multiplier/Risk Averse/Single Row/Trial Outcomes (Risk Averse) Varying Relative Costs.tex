...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.5464) -- (3.375,1.5403);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.2498) circle(0.05cm); 
\draw[blue, opacity=0.70, line width=0.5mm, double] (5.0917,2.6951) circle(0.05cm); 
