...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.1625) -- (3.375,2.1625);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.1382) -- (3.375,1.7684);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.0539) circle(0.05cm); 
\draw[blue, opacity=0.70, line width=0.5mm, double] (5.0917,2.148) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.3125) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (5.0917,2.2895) circle(0.05cm); 
