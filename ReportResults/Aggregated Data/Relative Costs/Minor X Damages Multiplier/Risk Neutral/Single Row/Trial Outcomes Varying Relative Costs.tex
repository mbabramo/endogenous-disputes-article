...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.4656) -- (3.375,1.4995) -- (5.0917,1.5043);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.9061) circle(0.05cm); 
\draw[blue, opacity=0.70, line width=0.5mm, double] (5.0917,1.5403) circle(0.05cm); 
