...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.4995) -- (3.375,2.3643) -- (5.0917,2.6965);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,2.288) -- (5.0917,2.3559);
