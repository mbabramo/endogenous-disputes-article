...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,2.9968) -- (2.6125,3.0032) -- (3.8208,2.9581);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,2.9799) -- (2.6125,2.97) -- (3.8208,2.9664);
