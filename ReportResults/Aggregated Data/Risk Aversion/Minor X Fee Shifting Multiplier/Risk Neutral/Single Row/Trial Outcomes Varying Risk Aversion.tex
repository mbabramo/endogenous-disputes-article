...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,2.5387) -- (2.6125,2.6176) -- (3.8208,2.9081);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,2.5071) -- (2.6125,2.3248) -- (3.8208,2.4688);
