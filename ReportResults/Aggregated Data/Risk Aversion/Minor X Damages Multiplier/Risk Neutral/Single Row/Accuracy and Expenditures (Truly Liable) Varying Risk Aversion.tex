...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,2.7977) -- (2.6125,2.8) -- (3.8208,1.464);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.4042,1.1) -- (2.6125,1.1) -- (3.8208,1.4832);
\draw[green, opacity=0.70, line width=1mm, solid] (1.4042,1.1544) -- (2.6125,1.1012) -- (3.8208,1.7895);
