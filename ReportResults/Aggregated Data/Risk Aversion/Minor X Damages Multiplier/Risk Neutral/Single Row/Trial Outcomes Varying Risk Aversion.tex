...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,1.9931) -- (2.6125,2.5387) -- (3.8208,1.9343);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,2.8691) -- (2.6125,2.5071) -- (3.8208,2.8067);
