...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.2386) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.51) -- (3.375,1.6089) -- (5.0917,1.5132);
