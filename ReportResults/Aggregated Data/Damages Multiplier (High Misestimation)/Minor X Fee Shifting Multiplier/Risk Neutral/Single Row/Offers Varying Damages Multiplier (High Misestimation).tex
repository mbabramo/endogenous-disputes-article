...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.4694) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.4356) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.8021) -- (3.375,3.0776) -- (5.0917,2.8588);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.5386) -- (3.375,1.9579) -- (5.0917,1.8957);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.3864) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.7859) circle(0.05cm); 
