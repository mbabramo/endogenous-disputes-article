...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.1553) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.3393) -- (3.375,3.1721) -- (5.0917,3.2008);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.7411) circle(0.05cm); 
