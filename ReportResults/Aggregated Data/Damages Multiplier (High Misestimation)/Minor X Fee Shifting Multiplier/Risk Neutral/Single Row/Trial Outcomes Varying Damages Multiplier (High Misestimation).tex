...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.7505) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.7353) -- (3.375,2.6891) -- (5.0917,2.826);
