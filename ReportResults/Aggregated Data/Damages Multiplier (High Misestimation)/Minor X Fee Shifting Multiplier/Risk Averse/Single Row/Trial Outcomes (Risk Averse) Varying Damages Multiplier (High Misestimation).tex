...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.6291) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.9624) -- (3.375,2.9097);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.8044) circle(0.05cm); 
