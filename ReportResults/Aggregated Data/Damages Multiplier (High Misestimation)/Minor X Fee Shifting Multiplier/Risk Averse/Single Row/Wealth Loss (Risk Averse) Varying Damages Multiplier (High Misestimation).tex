...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.9754) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.0436) -- (3.375,2.9733) -- (5.0917,2.9648);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.6025) circle(0.05cm); 
