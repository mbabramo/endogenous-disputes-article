...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1538) -- (3.375,1.1019) -- (5.0917,1.1);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1086) circle(0.05cm); 
