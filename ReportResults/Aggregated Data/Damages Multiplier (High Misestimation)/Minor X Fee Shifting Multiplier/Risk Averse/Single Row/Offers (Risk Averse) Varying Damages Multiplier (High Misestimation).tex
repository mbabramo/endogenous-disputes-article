...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.1538) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.3145) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.5409) -- (3.375,1.5483);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.1858) -- (3.375,1.44);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.4435) circle(0.05cm); 
