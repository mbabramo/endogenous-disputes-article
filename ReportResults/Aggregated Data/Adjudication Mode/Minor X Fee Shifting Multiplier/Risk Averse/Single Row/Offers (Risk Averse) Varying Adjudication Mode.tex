...
\draw[blue, opacity=0.70, line width=0.5mm, double] (2.1667,2.3125) -- (4.9,1.693) -- (7.6333,2.3047);
\draw[orange, opacity=0.70, line width=1mm, dashed] (2.1667,2.3331) -- (4.9,1.3125) -- (7.6333,2.0924);
