...
\draw[blue, opacity=0.70, line width=0.5mm, double] (2.1667,2.5875) -- (4.9,3.0125) -- (7.6333,3.037);
\draw[orange, opacity=0.70, line width=1mm, dashed] (2.1667,1.7375) -- (4.9,1.5514) -- (7.6333,1.5366);
