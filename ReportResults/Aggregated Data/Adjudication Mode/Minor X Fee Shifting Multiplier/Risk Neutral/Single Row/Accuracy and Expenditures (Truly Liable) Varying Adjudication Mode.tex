...
\draw[blue, opacity=0.70, line width=0.5mm, double] (2.1667,2.5877) -- (4.9,2.7709) -- (7.6333,2.7794);
\draw[orange, opacity=0.70, line width=1mm, dashed] (2.1667,1.2819) -- (4.9,1.1338) -- (7.6333,1.1682);
\draw[green, opacity=0.70, line width=1mm, solid] (2.1667,1.8881) -- (4.9,1.1611) -- (7.6333,1.1822);
