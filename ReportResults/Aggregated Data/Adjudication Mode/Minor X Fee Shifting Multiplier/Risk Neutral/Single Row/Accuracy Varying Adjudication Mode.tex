...
\draw[blue, opacity=0.70, line width=0.5mm, double] (2.1667,1.1925) -- (4.9,1.1603) -- (7.6333,1.2);
\draw[orange, opacity=0.70, line width=1mm, dashed] (2.1667,1.1344) -- (4.9,1.5091) -- (7.6333,1.5293);
