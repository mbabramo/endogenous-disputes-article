...
\draw[blue, opacity=0.70, line width=0.5mm, double] (2.1667,1.1344) -- (4.9,1.5091) -- (7.6333,1.5293);
\draw[orange, opacity=0.70, line width=1mm, dashed] (2.1667,1.1925) -- (4.9,1.1603) -- (7.6333,1.2);
\draw[green, opacity=0.70, line width=1mm, solid] (2.1667,1.2072) -- (4.9,1.1695) -- (7.6333,1.1899);
