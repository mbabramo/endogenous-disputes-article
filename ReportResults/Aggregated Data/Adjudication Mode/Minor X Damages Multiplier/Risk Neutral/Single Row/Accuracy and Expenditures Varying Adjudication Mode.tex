...
\draw[blue, opacity=0.70, line width=0.5mm, double] (2.1667,1.3078) -- (4.9,1.1172) -- (7.6333,1.1005);
\draw[orange, opacity=0.70, line width=1mm, dashed] (2.1667,1.1457) -- (4.9,1.1462) -- (7.6333,1.2087);
\draw[green, opacity=0.70, line width=1mm, solid] (2.1667,1.1521) -- (4.9,1.1536) -- (7.6333,1.1958);
