...
\draw[blue, opacity=0.70, line width=0.5mm, double] (2.1667,2.7991) -- (4.9,2.8) -- (7.6333,1.525);
\draw[orange, opacity=0.70, line width=1mm, dashed] (2.1667,1.1) -- (4.9,1.1) -- (7.6333,1.3636);
\draw[green, opacity=0.70, line width=1mm, solid] (2.1667,1.1188) -- (4.9,1.1) -- (7.6333,1.7809);
