...
\draw[blue, opacity=0.70, line width=0.5mm, double] (2.1667,2.5875) -- (4.9,2.3125) -- (7.6333,2.2593);
\draw[orange, opacity=0.70, line width=1mm, dashed] (2.1667,2.5875) -- (4.9,2.3331) -- (7.6333,2.3526);
