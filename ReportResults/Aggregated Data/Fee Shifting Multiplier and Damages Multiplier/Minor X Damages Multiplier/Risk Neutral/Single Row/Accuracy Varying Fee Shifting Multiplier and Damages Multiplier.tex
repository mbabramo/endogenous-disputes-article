...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.2517,1.1176) -- (2.155,1.15) -- (3.0583,1.2562);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.2517,1.5355) -- (2.155,1.3147) -- (3.0583,1.1381);
