...
\draw[blue, opacity=0.70, line width=0.5mm, double] (2.6125,2.6178) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,2.4495) -- (2.6125,2.6178);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,1.9624) -- (2.6125,2.9097);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,1.9606) circle(0.05cm); 
