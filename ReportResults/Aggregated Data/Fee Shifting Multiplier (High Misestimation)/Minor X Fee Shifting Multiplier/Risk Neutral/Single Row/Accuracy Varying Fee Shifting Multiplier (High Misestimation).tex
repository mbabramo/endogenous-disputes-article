...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.2248) -- (3.375,1.8236) -- (5.0917,1.9174);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.9301) -- (3.375,1.977) -- (5.0917,2.1447);
