...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.8502) -- (3.375,1.8775) -- (5.0917,2.101);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.8493) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.8459) circle(0.05cm); 
