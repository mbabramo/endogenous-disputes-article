...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.6291) -- (3.375,1.9624) -- (5.0917,1.8044);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,2.9097) circle(0.05cm); 
