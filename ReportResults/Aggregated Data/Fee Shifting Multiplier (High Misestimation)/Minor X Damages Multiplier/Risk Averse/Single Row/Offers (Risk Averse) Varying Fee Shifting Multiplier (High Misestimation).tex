...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.1538) -- (3.375,2.5409) -- (5.0917,1.4435);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.3145) -- (3.375,2.1858) -- (5.0917,1.44);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.5483) circle(0.05cm); 
