...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1) -- (3.375,1.1538) -- (5.0917,1.1086);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.1019) circle(0.05cm); 
