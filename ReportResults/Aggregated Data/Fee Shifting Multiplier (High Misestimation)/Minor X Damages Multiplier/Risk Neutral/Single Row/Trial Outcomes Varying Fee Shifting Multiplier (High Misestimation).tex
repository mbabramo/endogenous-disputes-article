...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.7505) -- (3.375,2.7353) -- (5.0917,2.8012);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,2.826) circle(0.05cm); 
