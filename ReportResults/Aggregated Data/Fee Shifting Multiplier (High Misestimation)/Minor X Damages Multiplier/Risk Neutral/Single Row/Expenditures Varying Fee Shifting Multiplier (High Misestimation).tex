...
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.8617) -- (3.375,2.6115) -- (5.0917,4.3928);
...
\draw[green, opacity=0.70, line width=1mm, solid] (3.375,1.9485) circle(0.05cm); 
...
\draw[green, opacity=0.70, line width=1mm, solid] (3.375,2.086) circle(0.05cm); 
