...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.2161) -- (3.375,1.3812) -- (5.0917,2.1872);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.4693) -- (3.375,1.3075) -- (5.0917,1.2274);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.2809) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,1.3192) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.3043) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,1.3612) circle(0.05cm); 
