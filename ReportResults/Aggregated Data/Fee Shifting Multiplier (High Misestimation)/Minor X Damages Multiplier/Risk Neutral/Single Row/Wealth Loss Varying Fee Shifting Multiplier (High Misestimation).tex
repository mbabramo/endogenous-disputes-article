...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.1553) -- (3.375,3.3393) -- (5.0917,3.7411);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,3.1721) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,3.2008) circle(0.05cm); 
