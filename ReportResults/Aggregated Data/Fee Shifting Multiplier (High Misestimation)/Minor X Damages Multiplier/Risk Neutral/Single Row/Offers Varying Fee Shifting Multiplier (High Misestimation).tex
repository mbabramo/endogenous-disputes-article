...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.4694) -- (3.375,2.8021) -- (5.0917,2.3864);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.4356) -- (3.375,2.5386) -- (5.0917,1.7859);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,3.0776) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,1.9579) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,2.8588) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,1.8957) circle(0.05cm); 
