...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.1199) -- (3.375,2.8907) -- (5.0917,2.7193);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.1255) -- (3.375,3.0694) -- (5.0917,2.7182);
