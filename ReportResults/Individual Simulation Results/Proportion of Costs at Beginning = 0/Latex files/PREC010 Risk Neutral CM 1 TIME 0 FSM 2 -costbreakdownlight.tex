...
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (7.5,2.5) rectangle (7.5121,3.1);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (7.5121,2.5) rectangle (7.5215,3.1);
\draw[pattern=grid,            pattern color=red!70!black,draw=black,very thin] (7.5121,3.1) rectangle (7.5215,4.3);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (7.5215,2.5) rectangle (7.5375,2.5001);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (7.5215,2.5001) rectangle (7.5375,3.1001);
\draw[pattern=grid,            pattern color=red!70!black,draw=black,very thin] (7.5215,3.1001) rectangle (7.5375,4.3001);
...
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (13.163,5.5) rectangle (13.262,6.1);
\draw[pattern=vertical lines, pattern color=orange,draw=black,very thin] (13.262,2.5) rectangle (13.285,5.5);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (13.262,5.5) rectangle (13.285,6.1);
\draw[pattern=crosshatch dots, pattern color=yellow,draw=black,very thin] (13.285,2.5) rectangle (13.359,5.5);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (13.285,5.5) rectangle (13.359,6.1);
\draw[pattern=grid,            pattern color=red!70!black,draw=black,very thin] (13.285,6.1) rectangle (13.359,7.3);
\draw[pattern=vertical lines, pattern color=orange,draw=black,very thin] (13.359,2.5) rectangle (13.378,5.5);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (13.359,5.5) rectangle (13.378,6.1);
\draw[pattern=grid,            pattern color=red!70!black,draw=black,very thin] (13.359,6.1) rectangle (13.378,7.3);
...
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (13.378,5.5001) rectangle (13.433,6.1001);
\draw[pattern=grid,            pattern color=red!70!black,draw=black,very thin] (13.378,6.1001) rectangle (13.433,7.3001);
...
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (13.433,5.5001) rectangle (13.5,6.1001);
\draw[pattern=grid,            pattern color=red!70!black,draw=black,very thin] (13.433,6.1001) rectangle (13.5,7.3001);
