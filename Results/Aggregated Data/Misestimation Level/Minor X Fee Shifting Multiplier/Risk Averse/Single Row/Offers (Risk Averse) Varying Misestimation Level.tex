...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,2.0913) -- (2.6125,2.512) -- (3.8208,2.0071);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.4042,2.4972) -- (2.6125,2.1951) -- (3.8208,1.8446);
