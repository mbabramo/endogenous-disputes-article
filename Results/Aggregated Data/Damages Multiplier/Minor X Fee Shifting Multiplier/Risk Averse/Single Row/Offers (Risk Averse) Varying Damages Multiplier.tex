...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,2.4027) -- (2.6125,2.0851) -- (3.8208,2.2647);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,2.3541) -- (2.6125,2.2365) -- (3.8208,2.3984);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.4042,2.495) -- (2.6125,2.364) -- (3.8208,2.5032);
