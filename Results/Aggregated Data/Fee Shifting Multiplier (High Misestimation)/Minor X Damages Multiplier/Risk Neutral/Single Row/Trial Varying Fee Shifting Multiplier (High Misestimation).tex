...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.357) -- (3.375,1.6242) -- (5.0917,2.2281);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.4651) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.2807) circle(0.05cm); 
