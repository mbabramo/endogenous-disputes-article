...
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.7366) -- (3.375,2.1762) -- (5.0917,4.1096);
...
\draw[green, opacity=0.70, line width=1mm, solid] (3.375,1.8367) circle(0.05cm); 
...
\draw[green, opacity=0.70, line width=1mm, solid] (3.375,1.763) circle(0.05cm); 
