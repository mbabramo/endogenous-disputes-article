...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.921) -- (3.375,2.7382) -- (5.0917,2.0659);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,3.1608) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,2.6852) circle(0.05cm); 
