...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1594) -- (3.375,1.2651) -- (5.0917,1.8571);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.6795) -- (3.375,1.2995) -- (5.0917,1.2843);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.2147) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,1.4684) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.2112) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,1.4621) circle(0.05cm); 
