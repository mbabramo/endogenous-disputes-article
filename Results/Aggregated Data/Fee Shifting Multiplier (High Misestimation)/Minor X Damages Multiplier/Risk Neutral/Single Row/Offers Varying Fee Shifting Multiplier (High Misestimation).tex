...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.6299) -- (3.375,2.6581) -- (5.0917,2.0767);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.6533) -- (3.375,1.9051) -- (5.0917,1.44);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,3.0593) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,1.44) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,3.0486) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,1.44) circle(0.05cm); 
