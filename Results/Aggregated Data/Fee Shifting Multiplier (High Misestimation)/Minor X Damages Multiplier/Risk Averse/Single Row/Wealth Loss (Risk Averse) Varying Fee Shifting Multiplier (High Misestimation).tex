...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.4985) -- (3.375,1.4977) -- (5.0917,1.6001);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.483) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.4769) circle(0.05cm); 
