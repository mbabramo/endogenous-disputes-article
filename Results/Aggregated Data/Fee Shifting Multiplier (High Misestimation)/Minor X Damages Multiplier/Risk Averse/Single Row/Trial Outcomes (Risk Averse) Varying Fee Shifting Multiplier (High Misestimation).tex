...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.0286) -- (3.375,3.4992) -- (5.0917,2.3811);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,3.1033) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,3.264) circle(0.05cm); 
