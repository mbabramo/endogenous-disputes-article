...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.2147) -- (3.375,1.1154) -- (5.0917,1.1141);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.1141) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.104) circle(0.05cm); 
