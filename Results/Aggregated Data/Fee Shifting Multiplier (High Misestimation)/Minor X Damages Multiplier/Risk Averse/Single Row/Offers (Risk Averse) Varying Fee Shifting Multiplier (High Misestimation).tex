...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.4891) -- (3.375,2.1796) -- (5.0917,1.447);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.9955) -- (3.375,2.1067) -- (5.0917,1.44);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,3.209) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,2.2606) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,2.7567) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,2.2065) circle(0.05cm); 
