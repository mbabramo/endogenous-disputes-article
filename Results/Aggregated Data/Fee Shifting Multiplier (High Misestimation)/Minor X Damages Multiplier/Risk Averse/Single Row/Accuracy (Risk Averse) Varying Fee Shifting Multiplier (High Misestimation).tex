...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1526) -- (3.375,1.2139) -- (5.0917,1.6636);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.6613) -- (3.375,1.5506) -- (5.0917,1.3988);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.1156) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,1.5537) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.1116) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,1.7533) circle(0.05cm); 
