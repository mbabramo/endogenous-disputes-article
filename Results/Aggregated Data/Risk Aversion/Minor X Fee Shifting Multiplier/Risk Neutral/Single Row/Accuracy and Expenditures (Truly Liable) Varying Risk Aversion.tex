...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,2.7794) -- (2.6125,2.7931) -- (3.8208,2.7606);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.4042,1.1119) -- (2.6125,1.1101) -- (3.8208,1.1225);
\draw[green, opacity=0.70, line width=1mm, solid] (1.4042,1.1877) -- (2.6125,1.127) -- (3.8208,1.1499);
