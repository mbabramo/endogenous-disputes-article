...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,3.041) -- (2.6125,2.9963) -- (3.8208,2.9906);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,2.9787) -- (2.6125,2.9799) -- (3.8208,2.9799);
