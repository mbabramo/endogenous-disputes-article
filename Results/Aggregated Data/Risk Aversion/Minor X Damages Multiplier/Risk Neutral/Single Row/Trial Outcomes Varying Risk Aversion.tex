...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,3.0502) -- (2.6125,2.9899) -- (3.8208,1.4825);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,2.9638) -- (2.6125,2.8244) -- (3.8208,2.62);
