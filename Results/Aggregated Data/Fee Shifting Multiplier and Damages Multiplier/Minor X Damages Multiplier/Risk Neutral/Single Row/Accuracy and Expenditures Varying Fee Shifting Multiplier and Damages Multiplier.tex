...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.2517,1.6128) -- (2.155,1.5598) -- (3.0583,1.2769);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.2517,1.1437) -- (2.155,1.1549) -- (3.0583,1.1329);
\draw[green, opacity=0.70, line width=1mm, solid] (1.2517,1.1945) -- (2.155,1.1614) -- (3.0583,1.1228);
