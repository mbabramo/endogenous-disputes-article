...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.8172) -- (3.375,2.7131) -- (5.0917,2.6451);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.2434) -- (3.375,2.5373) -- (5.0917,2.9121);
