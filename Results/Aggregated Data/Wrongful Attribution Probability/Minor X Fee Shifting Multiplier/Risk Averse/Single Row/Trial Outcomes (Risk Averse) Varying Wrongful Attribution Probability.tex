...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.3538) -- (3.375,2.9626) -- (5.0917,2.9655);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.8656) -- (3.375,2.6485) -- (5.0917,2.6602);
