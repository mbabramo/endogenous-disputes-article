...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.0286) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.4992) -- (3.375,3.1033) -- (5.0917,3.264);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.3811) circle(0.05cm); 
