...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.2147) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1154) -- (3.375,1.1141) -- (5.0917,1.104);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1141) circle(0.05cm); 
