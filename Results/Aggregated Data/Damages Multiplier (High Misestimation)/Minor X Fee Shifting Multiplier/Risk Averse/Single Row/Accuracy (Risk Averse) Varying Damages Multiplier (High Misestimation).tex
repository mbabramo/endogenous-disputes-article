...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.2052) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.2226) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.3278) -- (3.375,1.1312) -- (5.0917,1.1232);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.0012) -- (3.375,2.0073) -- (5.0917,2.4066);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.2273) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.6976) circle(0.05cm); 
