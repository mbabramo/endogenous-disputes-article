...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.0926) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.0883) -- (3.375,3.015) -- (5.0917,2.9846);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.6003) circle(0.05cm); 
