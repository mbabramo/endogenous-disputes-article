...
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.6138) circle(0.05cm); 
...
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.5726) -- (3.375,1.2392) -- (5.0917,1.1931);
...
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,3.8257) circle(0.05cm); 
