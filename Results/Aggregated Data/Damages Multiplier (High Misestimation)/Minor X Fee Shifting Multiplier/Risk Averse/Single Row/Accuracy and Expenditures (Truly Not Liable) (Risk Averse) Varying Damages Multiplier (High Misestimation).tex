...
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.2765) circle(0.05cm); 
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.2907) circle(0.05cm); 
...
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.4079) -- (3.375,1.128) -- (5.0917,1.1313);
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.3495) -- (3.375,1.1297) -- (5.0917,1.132);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.4636) circle(0.05cm); 
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,2.462) circle(0.05cm); 
