...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.4891) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.9955) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.1796) -- (3.375,3.209) -- (5.0917,2.7567);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.1067) -- (3.375,2.2606) -- (5.0917,2.2065);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.447) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.44) circle(0.05cm); 
