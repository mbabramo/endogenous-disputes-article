...
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.7366) circle(0.05cm); 
...
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,2.1762) -- (3.375,1.8367) -- (5.0917,1.763);
...
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,4.1096) circle(0.05cm); 
