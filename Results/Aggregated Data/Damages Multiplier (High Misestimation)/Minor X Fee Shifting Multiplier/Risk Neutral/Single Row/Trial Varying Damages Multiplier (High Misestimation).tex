...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.357) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.6242) -- (3.375,1.4651) -- (5.0917,1.2807);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.2281) circle(0.05cm); 
