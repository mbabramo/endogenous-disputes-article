...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.2188) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.259) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.4301) -- (3.375,1.3293) -- (5.0917,1.3225);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.499) -- (3.375,1.8367) -- (5.0917,1.8242);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.6142) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.4686) circle(0.05cm); 
