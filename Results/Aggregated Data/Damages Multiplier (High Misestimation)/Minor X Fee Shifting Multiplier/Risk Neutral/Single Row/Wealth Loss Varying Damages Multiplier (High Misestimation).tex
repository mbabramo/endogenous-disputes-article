...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.1231) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.2319) -- (3.375,3.1524) -- (5.0917,3.1352);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.6216) circle(0.05cm); 
