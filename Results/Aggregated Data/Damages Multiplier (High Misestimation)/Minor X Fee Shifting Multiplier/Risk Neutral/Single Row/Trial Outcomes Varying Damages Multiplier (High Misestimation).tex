...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.921) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.7382) -- (3.375,3.1608) -- (5.0917,2.6852);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.0659) circle(0.05cm); 
