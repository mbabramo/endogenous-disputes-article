...
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.3056) circle(0.05cm); 
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.3311) circle(0.05cm); 
...
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.4804) -- (3.375,1.2881) -- (5.0917,1.3211);
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.4805) -- (3.375,1.331) -- (5.0917,1.3244);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.5634) circle(0.05cm); 
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,2.5345) circle(0.05cm); 
