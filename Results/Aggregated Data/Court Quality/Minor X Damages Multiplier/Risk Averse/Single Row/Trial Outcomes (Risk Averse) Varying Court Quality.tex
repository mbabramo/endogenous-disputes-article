...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.2988) -- (3.375,2.7211) -- (5.0917,1.7707);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.0323) -- (3.375,2.676) -- (5.0917,3.6049);
