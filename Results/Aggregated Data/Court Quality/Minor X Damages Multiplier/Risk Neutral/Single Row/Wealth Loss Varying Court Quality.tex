...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.1124) -- (3.375,3.0353) -- (5.0917,3.0423);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.9799) -- (3.375,2.9799) -- (5.0917,2.9989);
