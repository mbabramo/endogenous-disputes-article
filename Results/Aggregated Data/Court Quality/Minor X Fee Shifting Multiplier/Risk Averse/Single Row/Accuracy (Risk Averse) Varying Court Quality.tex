...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1092) -- (3.375,1.1292) -- (5.0917,1.1);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.1998) -- (3.375,1.3602) -- (5.0917,1.8645);
...
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.3302) -- (3.375,2.6703) -- (5.0917,2.7722);
