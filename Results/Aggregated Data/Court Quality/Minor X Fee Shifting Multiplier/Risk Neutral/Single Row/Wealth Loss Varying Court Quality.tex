...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.0353) -- (3.375,3.0446) -- (5.0917,3.0269);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.9799) -- (3.375,2.9901) -- (5.0917,2.9734);
