...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.4592) -- (3.375,2.9139) -- (5.0917,2.7781);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.8388) -- (3.375,2.1796) -- (5.0917,2.6564);
