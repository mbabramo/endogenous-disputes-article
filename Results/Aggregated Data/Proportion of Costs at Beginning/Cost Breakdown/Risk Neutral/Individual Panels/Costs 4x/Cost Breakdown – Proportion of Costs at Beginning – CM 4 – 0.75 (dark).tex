...
\draw[fill=blue!30,draw=white,very thin] (14.104,2.5001) rectangle (14.268,5.4334);
\draw[fill=green!85,draw=white,very thin] (14.268,2.5) rectangle (14.548,2.5001);
\draw[fill=blue!30,draw=white,very thin] (14.268,2.5001) rectangle (14.548,5.4334);
\draw[fill=yellow!85,draw=white,very thin] (14.548,2.5) rectangle (18.728,7.3888);
\draw[fill=blue!30,draw=white,very thin] (14.548,7.3888) rectangle (18.728,10.322);
\draw[fill=orange!85,draw=white,very thin] (18.728,2.5) rectangle (20.62,7.3888);
\draw[fill=blue!30,draw=white,very thin] (18.728,7.3888) rectangle (20.62,10.322);
...
\draw[fill=blue!30,draw=white,very thin] (20.62,7.3889) rectangle (21.163,10.322);
...
\draw[fill=blue!30,draw=white,very thin] (21.163,7.3889) rectangle (22.081,10.322);
...
\draw[fill=blue!30,draw=white,very thin] (22.081,7.3889) rectangle (22.526,10.322);
...
\draw[fill=blue!30,draw=white,very thin] (22.526,7.3889) rectangle (23.35,10.322);
...
\draw[fill=blue!30,draw=white,very thin] (23.35,7.389) rectangle (23.867,10.322);
...
\draw[fill=blue!30,draw=white,very thin] (23.867,7.389) rectangle (25.167,10.322);
