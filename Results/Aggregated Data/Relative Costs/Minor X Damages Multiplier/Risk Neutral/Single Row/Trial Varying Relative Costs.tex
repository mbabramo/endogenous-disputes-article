...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1458) -- (3.375,1.2383) -- (5.0917,1.2297);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1305) -- (3.375,1.2299) -- (5.0917,1.2328);
