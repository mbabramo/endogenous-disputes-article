...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.0424) -- (3.375,3.0571) -- (5.0917,3.0317);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.9899) -- (3.375,3.0323) -- (5.0917,3.0293);
