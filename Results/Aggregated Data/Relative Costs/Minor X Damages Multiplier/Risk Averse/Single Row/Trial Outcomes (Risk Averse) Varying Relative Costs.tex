...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.7549) circle(0.05cm); 
\draw[blue, opacity=0.70, line width=0.5mm, double] (5.0917,2.7675) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.2609) -- (3.375,2.3778);
