...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.0125) circle(0.05cm); 
\draw[blue, opacity=0.70, line width=0.5mm, double] (5.0917,2.3315) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.5311) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (5.0917,2.53) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.2583) -- (3.375,3.4375);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.3125) -- (3.375,2.8951);
