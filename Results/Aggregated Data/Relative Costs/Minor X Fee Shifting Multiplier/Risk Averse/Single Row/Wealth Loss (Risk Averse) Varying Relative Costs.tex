...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.0135) -- (3.375,2.9814) -- (5.0917,2.9585);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.9851) -- (3.375,2.9867) -- (5.0917,2.9799);
