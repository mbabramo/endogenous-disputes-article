...
\node[font=\small,text=black, anchor=east] at (1.45, 5.9823) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.4646) -- (1.55,9.4646);
\node[font=\small,text=black, anchor=east] at (1.45, 9.4646) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,12.947) -- (1.55,12.947);
\node[font=\small,text=black, anchor=east] at (1.45, 12.947) {$\frac{3}{10^{4}}$};
