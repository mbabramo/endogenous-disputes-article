...
\node[font=\small,text=black, anchor=east] at (1.45, 5.8086) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.1172) -- (1.55,9.1172);
\node[font=\small,text=black, anchor=east] at (1.45, 9.1172) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,12.426) -- (1.55,12.426);
\node[font=\small,text=black, anchor=east] at (1.45, 12.426) {$\frac{3}{10^{4}}$};
