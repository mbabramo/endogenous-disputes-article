...
\node[font=\small,text=white, anchor=east] at (1.45, 5.5329) {0.0001};
\draw[white,very thin] (1.45,8.5658) -- (1.55,8.5658);
\node[font=\small,text=white, anchor=east] at (1.45, 8.5658) {0.0002};
\draw[white,very thin] (1.45,11.599) -- (1.55,11.599);
\node[font=\small,text=white, anchor=east] at (1.45, 11.599) {0.0003};
