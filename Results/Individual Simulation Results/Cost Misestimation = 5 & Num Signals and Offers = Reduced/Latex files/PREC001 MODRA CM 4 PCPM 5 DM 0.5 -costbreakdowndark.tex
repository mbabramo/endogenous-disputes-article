...
\node[font=\small,text=white, anchor=east] at (1.45, 5.4959) {0.0001};
\draw[white,very thin] (1.45,8.4918) -- (1.55,8.4918);
\node[font=\small,text=white, anchor=east] at (1.45, 8.4918) {0.0002};
\draw[white,very thin] (1.45,11.488) -- (1.55,11.488);
\node[font=\small,text=white, anchor=east] at (1.45, 11.488) {0.0003};
