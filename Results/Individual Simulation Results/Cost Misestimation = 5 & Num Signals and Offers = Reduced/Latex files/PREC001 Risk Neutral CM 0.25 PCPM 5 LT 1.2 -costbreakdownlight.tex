...
\begin{document}
\begin{tikzpicture}
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (4.6391,2.5) rectangle (5.5,2.7968);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (5.5,2.5) rectangle (7.5,3.0936);
...
\node[font=\small,text=black, anchor=east] at (1.45, 5.4681) {0.0001};
\draw[black,very thin] (1.45,8.4362) -- (1.55,8.4362);
\node[font=\small,text=black, anchor=east] at (1.45, 8.4362) {0.0002};
\draw[black,very thin] (1.45,11.404) -- (1.55,11.404);
\node[font=\small,text=black, anchor=east] at (1.45, 11.404) {0.0003};
\draw[black,very thin] (1.45,14.372) -- (1.55,14.372);
\node[font=\small,text=black, anchor=east] at (1.45, 14.372) {0.0004};
