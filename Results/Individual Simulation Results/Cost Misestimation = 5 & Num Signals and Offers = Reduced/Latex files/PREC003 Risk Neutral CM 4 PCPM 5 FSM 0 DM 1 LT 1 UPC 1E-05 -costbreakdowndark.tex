...
\node[font=\small,text=white, anchor=east] at (1.45, 5.8202) {$\frac{1}{10^{4}}$};
\draw[white,very thin] (1.45,9.1404) -- (1.55,9.1404);
\node[font=\small,text=white, anchor=east] at (1.45, 9.1404) {$\frac{2}{10^{4}}$};
\draw[white,very thin] (1.45,12.461) -- (1.55,12.461);
\node[font=\small,text=white, anchor=east] at (1.45, 12.461) {$\frac{3}{10^{4}}$};
