...
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (7.5891,2.5) rectangle (7.6638,2.8);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (7.5891,2.8) rectangle (7.6638,3.1);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (7.5891,3.1) rectangle (7.6638,3.7);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (7.6638,2.5) rectangle (7.6914,2.8);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (7.6638,2.8) rectangle (7.6914,3.1);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (7.6638,3.1) rectangle (7.6914,3.7);
\draw[pattern=grid,            pattern color=red!70!black,draw=black,very thin] (7.6638,3.7) rectangle (7.6914,4.3);
...
\draw[pattern=crosshatch dots, pattern color=yellow,draw=black,very thin] (12.44,2.5) rectangle (12.796,5.5);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (12.44,5.5) rectangle (12.796,5.8);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (12.44,5.8) rectangle (12.796,6.1);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (12.44,6.1) rectangle (12.796,6.7);
\draw[pattern=vertical lines, pattern color=orange,draw=black,very thin] (12.796,2.5) rectangle (13.187,5.5);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (12.796,5.5) rectangle (13.187,5.8);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (12.796,5.8) rectangle (13.187,6.1);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (12.796,6.1) rectangle (13.187,6.7);
\draw[pattern=crosshatch dots, pattern color=yellow,draw=black,very thin] (13.187,2.5) rectangle (13.316,5.5);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (13.187,5.5) rectangle (13.316,5.8);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (13.187,5.8) rectangle (13.316,6.1);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (13.187,6.1) rectangle (13.316,6.7);
\draw[pattern=grid,            pattern color=red!70!black,draw=black,very thin] (13.187,6.7) rectangle (13.316,7.3);
\draw[pattern=vertical lines, pattern color=orange,draw=black,very thin] (13.316,2.5) rectangle (13.463,5.5);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (13.316,5.5) rectangle (13.463,5.8);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (13.316,5.8) rectangle (13.463,6.1);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (13.316,6.1) rectangle (13.463,6.7);
\draw[pattern=grid,            pattern color=red!70!black,draw=black,very thin] (13.316,6.7) rectangle (13.463,7.3);
...
\node[font=\small,text=black, anchor=east] at (1.45, 5.9908) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.4816) -- (1.55,9.4816);
\node[font=\small,text=black, anchor=east] at (1.45, 9.4816) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,12.972) -- (1.55,12.972);
\node[font=\small,text=black, anchor=east] at (1.45, 12.972) {$\frac{3}{10^{4}}$};
