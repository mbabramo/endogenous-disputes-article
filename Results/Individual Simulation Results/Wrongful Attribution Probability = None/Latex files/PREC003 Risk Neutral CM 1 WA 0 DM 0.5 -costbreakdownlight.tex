...
\node[font=\small,text=black, anchor=east] at (1.45, 6.2452) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.9904) -- (1.55,9.9904);
\node[font=\small,text=black, anchor=east] at (1.45, 9.9904) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,13.736) -- (1.55,13.736);
\node[font=\small,text=black, anchor=east] at (1.45, 13.736) {$\frac{3}{10^{4}}$};
