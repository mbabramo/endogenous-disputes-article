...
\node[font=\small,text=black, anchor=east] at (1.45, 6.3323) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,10.165) -- (1.55,10.165);
\node[font=\small,text=black, anchor=east] at (1.45, 10.165) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,13.997) -- (1.55,13.997);
\node[font=\small,text=black, anchor=east] at (1.45, 13.997) {$\frac{3}{10^{4}}$};
