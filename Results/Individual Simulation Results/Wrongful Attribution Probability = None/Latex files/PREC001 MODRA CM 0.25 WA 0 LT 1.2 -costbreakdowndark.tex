...
\node[font=\small,text=white, anchor=east] at (1.45, 5.7398) {0.0001};
\draw[white,very thin] (1.45,8.9796) -- (1.55,8.9796);
\node[font=\small,text=white, anchor=east] at (1.45, 8.9796) {0.0002};
\draw[white,very thin] (1.45,12.219) -- (1.55,12.219);
\node[font=\small,text=white, anchor=east] at (1.45, 12.219) {0.0003};
