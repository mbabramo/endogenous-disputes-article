...
\node[font=\small,text=black, anchor=east] at (1.45, 6.4004) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,10.301) -- (1.55,10.301);
\node[font=\small,text=black, anchor=east] at (1.45, 10.301) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,14.201) -- (1.55,14.201);
\node[font=\small,text=black, anchor=east] at (1.45, 14.201) {$\frac{3}{10^{4}}$};
