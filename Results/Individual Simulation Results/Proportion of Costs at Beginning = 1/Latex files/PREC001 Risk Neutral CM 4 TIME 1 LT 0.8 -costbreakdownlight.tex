...
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (8.1158,5.5) rectangle (9.6683,7.9);
\draw[pattern=vertical lines, pattern color=orange,draw=black,very thin] (9.6683,2.5) rectangle (11.195,5.5);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (9.6683,5.5) rectangle (11.195,7.9);
...
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (11.195,5.5) rectangle (11.247,7.9);
...
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (11.247,5.5) rectangle (11.935,7.9);
...
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (11.935,5.5001) rectangle (11.974,7.9001);
...
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (11.974,5.5001) rectangle (12.579,7.9001);
...
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (12.579,5.5001) rectangle (12.615,7.9001);
...
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (12.615,5.5001) rectangle (13.5,7.9001);
