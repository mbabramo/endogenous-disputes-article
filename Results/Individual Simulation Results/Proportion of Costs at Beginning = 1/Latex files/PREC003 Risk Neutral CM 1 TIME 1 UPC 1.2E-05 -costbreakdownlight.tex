...
\node[font=\small,text=black, anchor=east] at (1.45, 5.8102) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.1204) -- (1.55,9.1204);
\node[font=\small,text=black, anchor=east] at (1.45, 9.1204) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,12.431) -- (1.55,12.431);
\node[font=\small,text=black, anchor=east] at (1.45, 12.431) {$\frac{3}{10^{4}}$};
