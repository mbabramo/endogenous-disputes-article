...
\node[font=\small,text=black, anchor=east] at (1.45, 6.2311) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.9622) -- (1.55,9.9622);
\node[font=\small,text=black, anchor=east] at (1.45, 9.9622) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,13.693) -- (1.55,13.693);
\node[font=\small,text=black, anchor=east] at (1.45, 13.693) {$\frac{3}{10^{4}}$};
