...
\node[font=\small,text=black, anchor=east] at (1.45, 6.224) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.948) -- (1.55,9.948);
\node[font=\small,text=black, anchor=east] at (1.45, 9.948) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,13.672) -- (1.55,13.672);
\node[font=\small,text=black, anchor=east] at (1.45, 13.672) {$\frac{3}{10^{4}}$};
