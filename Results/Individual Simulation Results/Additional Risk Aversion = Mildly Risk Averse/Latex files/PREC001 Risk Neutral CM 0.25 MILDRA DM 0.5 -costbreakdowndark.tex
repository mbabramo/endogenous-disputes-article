...
\node[font=\small,text=white, anchor=east] at (1.45, 5.9137) {0.0001};
\draw[white,very thin] (1.45,9.3273) -- (1.55,9.3273);
\node[font=\small,text=white, anchor=east] at (1.45, 9.3273) {0.0002};
\draw[white,very thin] (1.45,12.741) -- (1.55,12.741);
\node[font=\small,text=white, anchor=east] at (1.45, 12.741) {0.0003};
