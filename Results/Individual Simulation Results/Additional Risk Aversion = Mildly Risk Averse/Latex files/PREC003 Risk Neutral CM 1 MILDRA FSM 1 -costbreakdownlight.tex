...
\node[font=\small,text=black, anchor=east] at (1.45, 6.4326) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,10.365) -- (1.55,10.365);
\node[font=\small,text=black, anchor=east] at (1.45, 10.365) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,14.298) -- (1.55,14.298);
\node[font=\small,text=black, anchor=east] at (1.45, 14.298) {$\frac{3}{10^{4}}$};
