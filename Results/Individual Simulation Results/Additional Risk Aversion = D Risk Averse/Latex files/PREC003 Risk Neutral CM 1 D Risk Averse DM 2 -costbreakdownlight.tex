...
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (7.5,2.5) rectangle (9.1562,2.5001);
\draw[pattern=crosshatch dots, pattern color=yellow,draw=black,very thin] (7.5,2.5001) rectangle (9.1562,5.5001);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (9.1562,2.5) rectangle (9.1578,2.5001);
\draw[pattern=vertical lines, pattern color=orange,draw=black,very thin] (9.1562,2.5001) rectangle (9.1578,5.5001);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (9.1578,2.5) rectangle (13.493,2.5001);
\draw[pattern=crosshatch dots, pattern color=yellow,draw=black,very thin] (9.1578,2.5001) rectangle (13.493,5.5001);
