...
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (7.9315,2.5) rectangle (8.0604,2.8);
\draw[pattern=vertical lines, pattern color=orange,draw=black,very thin] (8.0604,2.5) rectangle (12.375,5.5);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (8.0604,5.5) rectangle (12.375,5.8);
...
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (12.375,5.5) rectangle (13.5,5.8);
