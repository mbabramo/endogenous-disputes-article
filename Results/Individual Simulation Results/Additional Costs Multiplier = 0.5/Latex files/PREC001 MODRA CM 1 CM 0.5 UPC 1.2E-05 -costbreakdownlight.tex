...
\begin{document}
\begin{tikzpicture}
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (1.5,2.5) rectangle (4.5,2.9237);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (4.5,2.5) rectangle (7.5,3.3474);
...
\node[font=\small,text=black, anchor=east] at (1.45, 6.0309) {0.0001};
\draw[black,very thin] (1.45,9.5617) -- (1.55,9.5617);
\node[font=\small,text=black, anchor=east] at (1.45, 9.5617) {0.0002};
\draw[black,very thin] (1.45,13.093) -- (1.55,13.093);
\node[font=\small,text=black, anchor=east] at (1.45, 13.093) {0.0003};
