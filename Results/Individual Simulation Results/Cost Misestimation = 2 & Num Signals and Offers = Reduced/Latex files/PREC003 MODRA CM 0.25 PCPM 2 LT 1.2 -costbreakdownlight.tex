...
\node[font=\small,text=black, anchor=east] at (1.45, 5.6084) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,8.7168) -- (1.55,8.7168);
\node[font=\small,text=black, anchor=east] at (1.45, 8.7168) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,11.825) -- (1.55,11.825);
\node[font=\small,text=black, anchor=east] at (1.45, 11.825) {$\frac{3}{10^{4}}$};
