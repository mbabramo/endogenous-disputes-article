...
\node[font=\small,text=black, anchor=east] at (1.45, 5.941) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.382) -- (1.55,9.382);
\node[font=\small,text=black, anchor=east] at (1.45, 9.382) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,12.823) -- (1.55,12.823);
\node[font=\small,text=black, anchor=east] at (1.45, 12.823) {$\frac{3}{10^{4}}$};
