...
\node[font=\small,text=white, anchor=east] at (1.45, 6.1461) {$\frac{1}{10^{4}}$};
\draw[white,very thin] (1.45,9.7922) -- (1.55,9.7922);
\node[font=\small,text=white, anchor=east] at (1.45, 9.7922) {$\frac{2}{10^{4}}$};
\draw[white,very thin] (1.45,13.438) -- (1.55,13.438);
\node[font=\small,text=white, anchor=east] at (1.45, 13.438) {$\frac{3}{10^{4}}$};
