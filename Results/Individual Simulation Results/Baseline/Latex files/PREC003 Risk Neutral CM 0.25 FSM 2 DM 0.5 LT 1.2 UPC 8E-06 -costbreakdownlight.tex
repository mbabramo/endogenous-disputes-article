...
\node[font=\small,text=black, anchor=east] at (1.45, 6.348) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,10.196) -- (1.55,10.196);
\node[font=\small,text=black, anchor=east] at (1.45, 10.196) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,14.044) -- (1.55,14.044);
\node[font=\small,text=black, anchor=east] at (1.45, 14.044) {$\frac{3}{10^{4}}$};
