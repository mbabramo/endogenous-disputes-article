...
\node[font=\small,text=black, anchor=east] at (1.45, 6.4211) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,10.342) -- (1.55,10.342);
\node[font=\small,text=black, anchor=east] at (1.45, 10.342) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,14.263) -- (1.55,14.263);
\node[font=\small,text=black, anchor=east] at (1.45, 14.263) {$\frac{3}{10^{4}}$};
