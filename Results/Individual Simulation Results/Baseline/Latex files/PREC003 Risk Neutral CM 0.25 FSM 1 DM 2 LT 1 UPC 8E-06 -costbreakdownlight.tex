...
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (2.8801,2.5) rectangle (3.6907,3.8329);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (3.6907,2.5) rectangle (7.5,4.1661);
...
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (7.7247,2.5) rectangle (8.2536,2.5001);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (7.7247,2.5001) rectangle (8.2536,2.5751);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (7.7247,2.5751) rectangle (8.2536,2.6501);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (7.7247,2.6501) rectangle (8.2536,2.8001);
...
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (10.091,2.5) rectangle (12.386,2.5001);
\draw[pattern=crosshatch dots, pattern color=yellow,draw=black,very thin] (10.091,2.5001) rectangle (12.386,5.5001);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (10.091,5.5001) rectangle (12.386,5.5751);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (10.091,5.5751) rectangle (12.386,5.6501);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (10.091,5.6501) rectangle (12.386,5.8001);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (12.386,2.5) rectangle (12.921,2.5001);
\draw[pattern=vertical lines, pattern color=orange,draw=black,very thin] (12.386,2.5001) rectangle (12.921,5.5001);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (12.386,5.5001) rectangle (12.921,5.5751);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (12.386,5.5751) rectangle (12.921,5.6501);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (12.386,5.6501) rectangle (12.921,5.8001);
...
\node[font=\small,text=black, anchor=east] at (1.45, 6.6652) {$\frac{1}{10^{4}}$};
