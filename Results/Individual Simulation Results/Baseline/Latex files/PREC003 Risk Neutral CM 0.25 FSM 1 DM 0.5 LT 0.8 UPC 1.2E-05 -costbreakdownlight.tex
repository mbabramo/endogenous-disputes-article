...
\node[font=\small,text=black, anchor=east] at (1.45, 6.1174) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.7347) -- (1.55,9.7347);
\node[font=\small,text=black, anchor=east] at (1.45, 9.7347) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,13.352) -- (1.55,13.352);
\node[font=\small,text=black, anchor=east] at (1.45, 13.352) {$\frac{3}{10^{4}}$};
