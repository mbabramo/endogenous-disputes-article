...
\node[font=\small,text=white, anchor=east] at (1.45, 5.9578) {0.0001};
\draw[white,very thin] (1.45,9.4156) -- (1.55,9.4156);
\node[font=\small,text=white, anchor=east] at (1.45, 9.4156) {0.0002};
\draw[white,very thin] (1.45,12.873) -- (1.55,12.873);
\node[font=\small,text=white, anchor=east] at (1.45, 12.873) {0.0003};
