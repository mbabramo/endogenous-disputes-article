...
\node[font=\small,text=black, anchor=east] at (1.45, 5.7889) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.0778) -- (1.55,9.0778);
\node[font=\small,text=black, anchor=east] at (1.45, 9.0778) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,12.367) -- (1.55,12.367);
\node[font=\small,text=black, anchor=east] at (1.45, 12.367) {$\frac{3}{10^{4}}$};
