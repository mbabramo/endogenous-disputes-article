...
\node[font=\small,text=white, anchor=east] at (1.45, 5.1778) {$\frac{1}{10^{4}}$};
\draw[white,very thin] (1.45,7.8555) -- (1.55,7.8555);
\node[font=\small,text=white, anchor=east] at (1.45, 7.8555) {$\frac{2}{10^{4}}$};
\draw[white,very thin] (1.45,10.533) -- (1.55,10.533);
\node[font=\small,text=white, anchor=east] at (1.45, 10.533) {$\frac{3}{10^{4}}$};
\draw[white,very thin] (1.45,13.211) -- (1.55,13.211);
\node[font=\small,text=white, anchor=east] at (1.45, 13.211) {$\frac{4}{10^{4}}$};
