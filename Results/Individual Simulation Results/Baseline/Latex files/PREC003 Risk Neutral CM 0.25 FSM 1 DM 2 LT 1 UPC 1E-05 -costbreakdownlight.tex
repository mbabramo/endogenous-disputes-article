...
\node[font=\small,text=black, anchor=east] at (1.45, 6.1657) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.8314) -- (1.55,9.8314);
\node[font=\small,text=black, anchor=east] at (1.45, 9.8314) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,13.497) -- (1.55,13.497);
\node[font=\small,text=black, anchor=east] at (1.45, 13.497) {$\frac{3}{10^{4}}$};
