...
\node[font=\small,text=white, anchor=east] at (1.45, 5.4345) {$\frac{1}{10^{4}}$};
\draw[white,very thin] (1.45,8.369) -- (1.55,8.369);
\node[font=\small,text=white, anchor=east] at (1.45, 8.369) {$\frac{2}{10^{4}}$};
\draw[white,very thin] (1.45,11.304) -- (1.55,11.304);
\node[font=\small,text=white, anchor=east] at (1.45, 11.304) {$\frac{3}{10^{4}}$};
