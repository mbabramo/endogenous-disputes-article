...
\node[font=\small,text=white, anchor=east] at (1.45, 5.8112) {0.0001};
\draw[white,very thin] (1.45,9.1225) -- (1.55,9.1225);
\node[font=\small,text=white, anchor=east] at (1.45, 9.1225) {0.0002};
\draw[white,very thin] (1.45,12.434) -- (1.55,12.434);
\node[font=\small,text=white, anchor=east] at (1.45, 12.434) {0.0003};
