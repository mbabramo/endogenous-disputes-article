...
\node[font=\small,text=black, anchor=east] at (1.45, 6.1407) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.7814) -- (1.55,9.7814);
\node[font=\small,text=black, anchor=east] at (1.45, 9.7814) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,13.422) -- (1.55,13.422);
\node[font=\small,text=black, anchor=east] at (1.45, 13.422) {$\frac{3}{10^{4}}$};
