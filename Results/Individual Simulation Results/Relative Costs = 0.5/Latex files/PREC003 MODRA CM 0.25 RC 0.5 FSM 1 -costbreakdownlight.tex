...
\node[font=\small,text=black, anchor=east] at (1.45, 6.0739) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.6478) -- (1.55,9.6478);
\node[font=\small,text=black, anchor=east] at (1.45, 9.6478) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,13.222) -- (1.55,13.222);
\node[font=\small,text=black, anchor=east] at (1.45, 13.222) {$\frac{3}{10^{4}}$};
