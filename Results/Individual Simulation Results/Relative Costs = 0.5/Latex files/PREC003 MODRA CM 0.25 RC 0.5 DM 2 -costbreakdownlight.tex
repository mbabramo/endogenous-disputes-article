...
\node[font=\small,text=black, anchor=east] at (1.45, 6.2169) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.9338) -- (1.55,9.9338);
\node[font=\small,text=black, anchor=east] at (1.45, 9.9338) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,13.651) -- (1.55,13.651);
\node[font=\small,text=black, anchor=east] at (1.45, 13.651) {$\frac{3}{10^{4}}$};
