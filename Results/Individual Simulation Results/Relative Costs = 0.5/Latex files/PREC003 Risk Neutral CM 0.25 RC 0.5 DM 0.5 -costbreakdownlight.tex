...
\node[font=\small,text=black, anchor=east] at (1.45, 6.1004) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.7008) -- (1.55,9.7008);
\node[font=\small,text=black, anchor=east] at (1.45, 9.7008) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,13.301) -- (1.55,13.301);
\node[font=\small,text=black, anchor=east] at (1.45, 13.301) {$\frac{3}{10^{4}}$};
