...
\node[font=\small,text=black, anchor=east] at (1.45, 6.2971) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,10.094) -- (1.55,10.094);
\node[font=\small,text=black, anchor=east] at (1.45, 10.094) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,13.891) -- (1.55,13.891);
\node[font=\small,text=black, anchor=east] at (1.45, 13.891) {$\frac{3}{10^{4}}$};
