...
\node[font=\small,text=black, anchor=east] at (1.45, 5.6414) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,8.7828) -- (1.55,8.7828);
\node[font=\small,text=black, anchor=east] at (1.45, 8.7828) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,11.924) -- (1.55,11.924);
\node[font=\small,text=black, anchor=east] at (1.45, 11.924) {$\frac{3}{10^{4}}$};
