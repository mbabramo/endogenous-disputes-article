...
\node[font=\small,text=black, anchor=east] at (1.45, 6.0406) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.5813) -- (1.55,9.5813);
\node[font=\small,text=black, anchor=east] at (1.45, 9.5813) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,13.122) -- (1.55,13.122);
\node[font=\small,text=black, anchor=east] at (1.45, 13.122) {$\frac{3}{10^{4}}$};
