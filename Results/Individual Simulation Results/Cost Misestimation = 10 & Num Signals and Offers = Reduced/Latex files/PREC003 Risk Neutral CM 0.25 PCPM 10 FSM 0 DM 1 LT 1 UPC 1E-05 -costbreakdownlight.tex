...
\node[font=\small,text=black, anchor=east] at (1.45, 5.8291) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.1581) -- (1.55,9.1581);
\node[font=\small,text=black, anchor=east] at (1.45, 9.1581) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,12.487) -- (1.55,12.487);
\node[font=\small,text=black, anchor=east] at (1.45, 12.487) {$\frac{3}{10^{4}}$};
