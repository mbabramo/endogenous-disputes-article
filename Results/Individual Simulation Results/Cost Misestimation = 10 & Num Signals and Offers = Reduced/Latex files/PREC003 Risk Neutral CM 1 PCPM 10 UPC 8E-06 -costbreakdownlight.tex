...
\begin{document}
\begin{tikzpicture}
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (3.4999,2.5) rectangle (4.2843,3.4185);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (4.2843,2.5) rectangle (5.0703,3.7246);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (5.0703,2.5) rectangle (7.5,4.0308);
...
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (9.1425,2.5) rectangle (10.511,2.5001);
\draw[pattern=crosshatch dots, pattern color=yellow,draw=black,very thin] (9.1425,2.5001) rectangle (10.511,5.5001);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (10.511,2.5) rectangle (10.829,2.5001);
\draw[pattern=vertical lines, pattern color=orange,draw=black,very thin] (10.511,2.5001) rectangle (10.829,5.5001);
...
\node[font=\small,text=black, anchor=east] at (1.45, 6.327) {$\frac{1}{10^{4}}$};
