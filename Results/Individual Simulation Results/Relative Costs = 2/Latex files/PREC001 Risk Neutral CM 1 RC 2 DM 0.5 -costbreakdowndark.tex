...
\node[font=\small,text=white, anchor=east] at (1.45, 5.6812) {0.0001};
\draw[white,very thin] (1.45,8.8625) -- (1.55,8.8625);
\node[font=\small,text=white, anchor=east] at (1.45, 8.8625) {0.0002};
\draw[white,very thin] (1.45,12.044) -- (1.55,12.044);
\node[font=\small,text=white, anchor=east] at (1.45, 12.044) {0.0003};
