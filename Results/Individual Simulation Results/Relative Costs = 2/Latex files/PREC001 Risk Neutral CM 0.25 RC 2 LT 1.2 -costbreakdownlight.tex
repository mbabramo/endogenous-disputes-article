...
\begin{document}
\begin{tikzpicture}
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (3.6907,2.5) rectangle (4.5,2.8401);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (4.5,2.5) rectangle (7.5,3.1803);
...
\node[font=\small,text=black, anchor=east] at (1.45, 5.9014) {0.0001};
\draw[black,very thin] (1.45,9.3028) -- (1.55,9.3028);
\node[font=\small,text=black, anchor=east] at (1.45, 9.3028) {0.0002};
\draw[black,very thin] (1.45,12.704) -- (1.55,12.704);
\node[font=\small,text=black, anchor=east] at (1.45, 12.704) {0.0003};
