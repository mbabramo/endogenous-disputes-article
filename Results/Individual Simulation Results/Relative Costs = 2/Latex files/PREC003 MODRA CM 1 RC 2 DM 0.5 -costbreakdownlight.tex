...
\node[font=\small,text=black, anchor=east] at (1.45, 6.1838) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.8676) -- (1.55,9.8676);
\node[font=\small,text=black, anchor=east] at (1.45, 9.8676) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,13.551) -- (1.55,13.551);
\node[font=\small,text=black, anchor=east] at (1.45, 13.551) {$\frac{3}{10^{4}}$};
