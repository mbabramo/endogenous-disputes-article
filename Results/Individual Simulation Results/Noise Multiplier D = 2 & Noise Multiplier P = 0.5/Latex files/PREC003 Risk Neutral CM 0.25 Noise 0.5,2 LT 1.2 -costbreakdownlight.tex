...
\node[font=\small,text=black, anchor=east] at (1.45, 5.7181) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,8.9363) -- (1.55,8.9363);
\node[font=\small,text=black, anchor=east] at (1.45, 8.9363) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,12.154) -- (1.55,12.154);
\node[font=\small,text=black, anchor=east] at (1.45, 12.154) {$\frac{3}{10^{4}}$};
