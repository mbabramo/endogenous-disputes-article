...
\node[font=\small,text=black, anchor=east] at (1.45, 6.2889) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,10.078) -- (1.55,10.078);
\node[font=\small,text=black, anchor=east] at (1.45, 10.078) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,13.867) -- (1.55,13.867);
\node[font=\small,text=black, anchor=east] at (1.45, 13.867) {$\frac{3}{10^{4}}$};
