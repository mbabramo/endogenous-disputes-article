...
\node[font=\small,text=white, anchor=east] at (1.45, 5.529) {0.0001};
\draw[white,very thin] (1.45,8.558) -- (1.55,8.558);
\node[font=\small,text=white, anchor=east] at (1.45, 8.558) {0.0002};
\draw[white,very thin] (1.45,11.587) -- (1.55,11.587);
\node[font=\small,text=white, anchor=east] at (1.45, 11.587) {0.0003};
