...
\node[font=\small,text=black, anchor=east] at (1.45, 5.8949) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.2897) -- (1.55,9.2897);
\node[font=\small,text=black, anchor=east] at (1.45, 9.2897) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,12.685) -- (1.55,12.685);
\node[font=\small,text=black, anchor=east] at (1.45, 12.685) {$\frac{3}{10^{4}}$};
