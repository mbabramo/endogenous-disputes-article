...
\begin{document}
\begin{tikzpicture}
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (4.5,2.5) rectangle (5.2511,2.8619);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (5.2511,2.5) rectangle (7.5,3.2239);
...
\node[font=\small,text=black, anchor=east] at (1.45, 5.5161) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,8.5321) -- (1.55,8.5321);
\node[font=\small,text=black, anchor=east] at (1.45, 8.5321) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,11.548) -- (1.55,11.548);
\node[font=\small,text=black, anchor=east] at (1.45, 11.548) {$\frac{3}{10^{4}}$};
