...
\node[font=\small,text=black, anchor=east] at (1.45, 6.29) {0.0001};
\draw[black,very thin] (1.45,10.08) -- (1.55,10.08);
\node[font=\small,text=black, anchor=east] at (1.45, 10.08) {0.0002};
\draw[black,very thin] (1.45,13.87) -- (1.55,13.87);
\node[font=\small,text=black, anchor=east] at (1.45, 13.87) {0.0003};
