...
\node[font=\small,text=white, anchor=east] at (1.45, 6.094) {0.0001};
\draw[white,very thin] (1.45,9.6879) -- (1.55,9.6879);
\node[font=\small,text=white, anchor=east] at (1.45, 9.6879) {0.0002};
\draw[white,very thin] (1.45,13.282) -- (1.55,13.282);
\node[font=\small,text=white, anchor=east] at (1.45, 13.282) {0.0003};
