...
\node[font=\small,text=black, anchor=east] at (1.45, 5.8511) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.2023) -- (1.55,9.2023);
\node[font=\small,text=black, anchor=east] at (1.45, 9.2023) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,12.553) -- (1.55,12.553);
\node[font=\small,text=black, anchor=east] at (1.45, 12.553) {$\frac{3}{10^{4}}$};
