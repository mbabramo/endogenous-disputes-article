...
\node[font=\small,text=black, anchor=east] at (1.45, 6.4021) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,10.304) -- (1.55,10.304);
\node[font=\small,text=black, anchor=east] at (1.45, 10.304) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,14.206) -- (1.55,14.206);
\node[font=\small,text=black, anchor=east] at (1.45, 14.206) {$\frac{3}{10^{4}}$};
