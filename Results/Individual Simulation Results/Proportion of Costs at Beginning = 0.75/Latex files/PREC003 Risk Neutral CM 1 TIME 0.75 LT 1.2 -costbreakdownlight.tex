...
\node[font=\small,text=black, anchor=east] at (1.45, 5.8033) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.1066) -- (1.55,9.1066);
\node[font=\small,text=black, anchor=east] at (1.45, 9.1066) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,12.41) -- (1.55,12.41);
\node[font=\small,text=black, anchor=east] at (1.45, 12.41) {$\frac{3}{10^{4}}$};
