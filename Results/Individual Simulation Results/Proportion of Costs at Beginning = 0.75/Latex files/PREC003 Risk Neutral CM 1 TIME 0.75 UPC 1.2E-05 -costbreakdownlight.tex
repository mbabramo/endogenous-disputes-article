...
\node[font=\small,text=black, anchor=east] at (1.45, 5.853) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.206) -- (1.55,9.206);
\node[font=\small,text=black, anchor=east] at (1.45, 9.206) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,12.559) -- (1.55,12.559);
\node[font=\small,text=black, anchor=east] at (1.45, 12.559) {$\frac{3}{10^{4}}$};
