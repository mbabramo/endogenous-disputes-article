...
\node[font=\small,text=black, anchor=east] at (1.45, 5.6288) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,8.7576) -- (1.55,8.7576);
\node[font=\small,text=black, anchor=east] at (1.45, 8.7576) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,11.886) -- (1.55,11.886);
\node[font=\small,text=black, anchor=east] at (1.45, 11.886) {$\frac{3}{10^{4}}$};
