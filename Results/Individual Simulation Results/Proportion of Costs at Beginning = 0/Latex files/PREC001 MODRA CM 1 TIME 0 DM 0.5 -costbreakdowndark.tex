...
\node[font=\small,text=white, anchor=east] at (1.45, 5.9337) {0.0001};
\draw[white,very thin] (1.45,9.3673) -- (1.55,9.3673);
\node[font=\small,text=white, anchor=east] at (1.45, 9.3673) {0.0002};
\draw[white,very thin] (1.45,12.801) -- (1.55,12.801);
\node[font=\small,text=white, anchor=east] at (1.45, 12.801) {0.0003};
