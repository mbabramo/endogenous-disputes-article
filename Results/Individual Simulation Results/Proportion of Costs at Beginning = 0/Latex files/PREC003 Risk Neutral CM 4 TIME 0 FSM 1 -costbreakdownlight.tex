...
\node[font=\small,text=black, anchor=east] at (1.45, 6.0938) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.6877) -- (1.55,9.6877);
\node[font=\small,text=black, anchor=east] at (1.45, 9.6877) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,13.281) -- (1.55,13.281);
\node[font=\small,text=black, anchor=east] at (1.45, 13.281) {$\frac{3}{10^{4}}$};
