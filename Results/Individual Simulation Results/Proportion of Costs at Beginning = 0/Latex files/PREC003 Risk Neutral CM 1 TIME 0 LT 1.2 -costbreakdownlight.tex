...
\node[font=\small,text=black, anchor=east] at (1.45, 5.9371) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.3742) -- (1.55,9.3742);
\node[font=\small,text=black, anchor=east] at (1.45, 9.3742) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,12.811) -- (1.55,12.811);
\node[font=\small,text=black, anchor=east] at (1.45, 12.811) {$\frac{3}{10^{4}}$};
