...
\node[font=\small,text=black, anchor=east] at (1.45, 4.1225) {0.0001};
\draw[black,very thin] (1.45,5.745) -- (1.55,5.745);
\node[font=\small,text=black, anchor=east] at (1.45, 5.745) {0.0002};
\draw[black,very thin] (1.45,7.3675) -- (1.55,7.3675);
\node[font=\small,text=black, anchor=east] at (1.45, 7.3675) {0.0003};
\draw[black,very thin] (1.45,8.99) -- (1.55,8.99);
\node[font=\small,text=black, anchor=east] at (1.45, 8.99) {0.0004};
\draw[black,very thin] (1.45,10.613) -- (1.55,10.613);
\node[font=\small,text=black, anchor=east] at (1.45, 10.613) {0.0005};
\draw[black,very thin] (1.45,12.235) -- (1.55,12.235);
\node[font=\small,text=black, anchor=east] at (1.45, 12.235) {0.0006};
\draw[black,very thin] (1.45,13.858) -- (1.55,13.858);
\node[font=\small,text=black, anchor=east] at (1.45, 13.858) {0.0007};
