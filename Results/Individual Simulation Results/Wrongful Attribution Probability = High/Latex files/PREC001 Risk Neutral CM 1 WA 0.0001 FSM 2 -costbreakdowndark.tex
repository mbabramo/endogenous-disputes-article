...
\node[font=\small,text=white, anchor=east] at (1.45, 5.967) {0.0001};
\draw[white,very thin] (1.45,9.4339) -- (1.55,9.4339);
\node[font=\small,text=white, anchor=east] at (1.45, 9.4339) {0.0002};
\draw[white,very thin] (1.45,12.901) -- (1.55,12.901);
\node[font=\small,text=white, anchor=east] at (1.45, 12.901) {0.0003};
