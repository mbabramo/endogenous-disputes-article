...
\node[font=\small,text=black, anchor=east] at (1.45, 4.366) {0.0001};
\draw[black,very thin] (1.45,6.232) -- (1.55,6.232);
\node[font=\small,text=black, anchor=east] at (1.45, 6.232) {0.0002};
\draw[black,very thin] (1.45,8.098) -- (1.55,8.098);
\node[font=\small,text=black, anchor=east] at (1.45, 8.098) {0.0003};
\draw[black,very thin] (1.45,9.964) -- (1.55,9.964);
\node[font=\small,text=black, anchor=east] at (1.45, 9.964) {0.0004};
\draw[black,very thin] (1.45,11.83) -- (1.55,11.83);
\node[font=\small,text=black, anchor=east] at (1.45, 11.83) {0.0005};
\draw[black,very thin] (1.45,13.696) -- (1.55,13.696);
\node[font=\small,text=black, anchor=east] at (1.45, 13.696) {0.0006};
