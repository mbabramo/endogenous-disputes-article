...
\node[font=\small,text=black, anchor=east] at (1.45, 4.2352) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,5.9704) -- (1.55,5.9704);
\node[font=\small,text=black, anchor=east] at (1.45, 5.9704) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,7.7056) -- (1.55,7.7056);
\node[font=\small,text=black, anchor=east] at (1.45, 7.7056) {$\frac{3}{10^{4}}$};
\draw[black,very thin] (1.45,9.4407) -- (1.55,9.4407);
\node[font=\small,text=black, anchor=east] at (1.45, 9.4407) {$\frac{4}{10^{4}}$};
\draw[black,very thin] (1.45,11.176) -- (1.55,11.176);
\node[font=\small,text=black, anchor=east] at (1.45, 11.176) {$\frac{5}{10^{4}}$};
\draw[black,very thin] (1.45,12.911) -- (1.55,12.911);
\node[font=\small,text=black, anchor=east] at (1.45, 12.911) {$\frac{6}{10^{4}}$};
