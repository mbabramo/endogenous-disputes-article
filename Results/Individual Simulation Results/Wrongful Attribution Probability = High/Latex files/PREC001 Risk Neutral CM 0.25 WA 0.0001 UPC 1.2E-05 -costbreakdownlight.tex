...
\node[font=\small,text=black, anchor=east] at (1.45, 4.1022) {0.0001};
\draw[black,very thin] (1.45,5.7043) -- (1.55,5.7043);
\node[font=\small,text=black, anchor=east] at (1.45, 5.7043) {0.0002};
\draw[black,very thin] (1.45,7.3065) -- (1.55,7.3065);
\node[font=\small,text=black, anchor=east] at (1.45, 7.3065) {0.0003};
\draw[black,very thin] (1.45,8.9087) -- (1.55,8.9087);
\node[font=\small,text=black, anchor=east] at (1.45, 8.9087) {0.0004};
\draw[black,very thin] (1.45,10.511) -- (1.55,10.511);
\node[font=\small,text=black, anchor=east] at (1.45, 10.511) {0.0005};
\draw[black,very thin] (1.45,12.113) -- (1.55,12.113);
\node[font=\small,text=black, anchor=east] at (1.45, 12.113) {0.0006};
\draw[black,very thin] (1.45,13.715) -- (1.55,13.715);
\node[font=\small,text=black, anchor=east] at (1.45, 13.715) {0.0007};
