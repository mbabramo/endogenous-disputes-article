...
\node[font=\small,text=black, anchor=east] at (1.45, 4.1122) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,5.7245) -- (1.55,5.7245);
\node[font=\small,text=black, anchor=east] at (1.45, 5.7245) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,7.3367) -- (1.55,7.3367);
\node[font=\small,text=black, anchor=east] at (1.45, 7.3367) {$\frac{3}{10^{4}}$};
\draw[black,very thin] (1.45,8.9489) -- (1.55,8.9489);
\node[font=\small,text=black, anchor=east] at (1.45, 8.9489) {$\frac{4}{10^{4}}$};
\draw[black,very thin] (1.45,10.561) -- (1.55,10.561);
\node[font=\small,text=black, anchor=east] at (1.45, 10.561) {$\frac{5}{10^{4}}$};
\draw[black,very thin] (1.45,12.173) -- (1.55,12.173);
\node[font=\small,text=black, anchor=east] at (1.45, 12.173) {$\frac{6}{10^{4}}$};
\draw[black,very thin] (1.45,13.786) -- (1.55,13.786);
\node[font=\small,text=black, anchor=east] at (1.45, 13.786) {$\frac{7}{10^{4}}$};
