...
\node[font=\small,text=black, anchor=east] at (1.45, 6.2413) {$\frac{1}{10^{4}}$};
\draw[black,very thin] (1.45,9.9825) -- (1.55,9.9825);
\node[font=\small,text=black, anchor=east] at (1.45, 9.9825) {$\frac{2}{10^{4}}$};
\draw[black,very thin] (1.45,13.724) -- (1.55,13.724);
\node[font=\small,text=black, anchor=east] at (1.45, 13.724) {$\frac{3}{10^{4}}$};
