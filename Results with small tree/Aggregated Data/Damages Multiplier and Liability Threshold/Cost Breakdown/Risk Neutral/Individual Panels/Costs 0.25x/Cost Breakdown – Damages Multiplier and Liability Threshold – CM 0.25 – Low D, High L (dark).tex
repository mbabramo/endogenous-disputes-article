...
\draw[fill=blue!30,draw=white,very thin] (13.333,2.5001) rectangle (13.772,2.605);
\draw[fill=blue!60,draw=white,very thin] (13.333,2.605) rectangle (13.772,2.71);
...
\draw[fill=blue!30,draw=white,very thin] (13.772,2.5001) rectangle (14.187,2.6051);
\draw[fill=blue!60,draw=white,very thin] (13.772,2.6051) rectangle (14.187,2.71);
\draw[fill=blue!90,draw=white,very thin] (13.772,2.71) rectangle (14.187,2.92);
\draw[fill=green!85,draw=white,very thin] (14.187,2.5) rectangle (14.379,2.5001);
\draw[fill=blue!30,draw=white,very thin] (14.187,2.5001) rectangle (14.379,2.605);
\draw[fill=blue!60,draw=white,very thin] (14.187,2.605) rectangle (14.379,2.71);
\draw[fill=blue!90,draw=white,very thin] (14.187,2.71) rectangle (14.379,2.9199);
\draw[fill=red!75,draw=white,very thin] (14.187,2.9199) rectangle (14.379,3.1298);
\draw[fill=green!85,draw=white,very thin] (14.379,2.5) rectangle (14.944,2.5001);
\draw[fill=blue!30,draw=white,very thin] (14.379,2.5001) rectangle (14.944,2.6051);
\draw[fill=blue!60,draw=white,very thin] (14.379,2.6051) rectangle (14.944,2.71);
\draw[fill=blue!90,draw=white,very thin] (14.379,2.71) rectangle (14.944,2.92);
...
\draw[fill=yellow!85,draw=white,very thin] (18.397,2.5001) rectangle (20.718,6.6985);
\draw[fill=blue!30,draw=white,very thin] (18.397,6.6985) rectangle (20.718,6.8035);
\draw[fill=blue!60,draw=white,very thin] (18.397,6.8035) rectangle (20.718,6.9084);
\draw[fill=blue!90,draw=white,very thin] (18.397,6.9084) rectangle (20.718,7.1183);
\draw[fill=green!85,draw=white,very thin] (20.718,2.5) rectangle (20.894,2.5001);
\draw[fill=orange!85,draw=white,very thin] (20.718,2.5001) rectangle (20.894,6.6985);
\draw[fill=blue!30,draw=white,very thin] (20.718,6.6985) rectangle (20.894,6.8035);
\draw[fill=blue!60,draw=white,very thin] (20.718,6.8035) rectangle (20.894,6.9084);
\draw[fill=blue!90,draw=white,very thin] (20.718,6.9084) rectangle (20.894,7.1183);
...
\draw[fill=yellow!85,draw=white,very thin] (22.302,2.5001) rectangle (23.632,6.6985);
\draw[fill=blue!30,draw=white,very thin] (22.302,6.6985) rectangle (23.632,6.8035);
\draw[fill=blue!60,draw=white,very thin] (22.302,6.8035) rectangle (23.632,6.9084);
\draw[fill=blue!90,draw=white,very thin] (22.302,6.9084) rectangle (23.632,7.1183);
\draw[fill=red!75,draw=white,very thin] (22.302,7.1183) rectangle (23.632,7.3283);
\draw[fill=green!85,draw=white,very thin] (23.632,2.5) rectangle (25.167,2.5001);
\draw[fill=orange!85,draw=white,very thin] (23.632,2.5001) rectangle (25.167,6.6985);
\draw[fill=blue!30,draw=white,very thin] (23.632,6.6985) rectangle (25.167,6.8035);
\draw[fill=blue!60,draw=white,very thin] (23.632,6.8035) rectangle (25.167,6.9084);
\draw[fill=blue!90,draw=white,very thin] (23.632,6.9084) rectangle (25.167,7.1183);
\draw[fill=red!75,draw=white,very thin] (23.632,7.1183) rectangle (25.167,7.3283);
