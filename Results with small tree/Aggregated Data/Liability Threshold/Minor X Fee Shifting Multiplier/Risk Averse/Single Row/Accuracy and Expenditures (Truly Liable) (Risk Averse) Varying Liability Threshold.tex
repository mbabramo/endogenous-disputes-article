...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.2517,4.0041) -- (2.155,3.7164) -- (3.0583,4.5);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.2517,1.1145) -- (2.155,1.3177) -- (3.0583,1.1);
\draw[green, opacity=0.70, line width=1mm, solid] (1.2517,1.5259) -- (2.155,1.5259) -- (3.0583,1.1);
