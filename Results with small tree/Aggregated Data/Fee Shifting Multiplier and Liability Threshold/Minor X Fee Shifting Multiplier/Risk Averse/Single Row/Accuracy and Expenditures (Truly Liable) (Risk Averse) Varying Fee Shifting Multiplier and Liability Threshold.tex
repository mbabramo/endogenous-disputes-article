...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.2517,1.7196) -- (2.155,1.7602) -- (3.0583,1.7613);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.2517,1.1152) -- (2.155,1.1094) -- (3.0583,1.1141);
\draw[green, opacity=0.70, line width=1mm, solid] (1.2517,1.2831) -- (2.155,1.1202) -- (3.0583,1.1202);
