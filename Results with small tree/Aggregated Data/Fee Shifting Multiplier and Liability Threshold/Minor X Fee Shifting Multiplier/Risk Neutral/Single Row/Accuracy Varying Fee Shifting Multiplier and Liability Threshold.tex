...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.2517,1.3512) -- (2.155,1.1819) -- (3.0583,1.191);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.2517,1.4006) -- (2.155,1.7238) -- (3.0583,1.7249);
