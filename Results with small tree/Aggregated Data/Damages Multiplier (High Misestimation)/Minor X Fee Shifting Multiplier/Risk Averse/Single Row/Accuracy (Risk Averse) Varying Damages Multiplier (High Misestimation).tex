...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.102) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.056) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.245) -- (3.375,1.1) -- (5.0917,1.1);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.1721) -- (3.375,1.3803) -- (5.0917,2.302);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.5099) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.1139) circle(0.05cm); 
