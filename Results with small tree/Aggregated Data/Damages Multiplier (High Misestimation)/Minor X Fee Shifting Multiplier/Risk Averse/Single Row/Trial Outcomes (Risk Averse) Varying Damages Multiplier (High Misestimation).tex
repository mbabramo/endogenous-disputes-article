...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.8158) -- (3.375,2.6546) -- (5.0917,3.1411);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.1523) circle(0.05cm); 
