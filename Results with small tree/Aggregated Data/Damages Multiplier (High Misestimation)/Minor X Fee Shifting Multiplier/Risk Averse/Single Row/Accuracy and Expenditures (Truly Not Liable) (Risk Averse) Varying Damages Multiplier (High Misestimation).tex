...
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.1037) circle(0.05cm); 
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.1033) circle(0.05cm); 
...
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.2492) -- (3.375,1.1) -- (5.0917,1.1);
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.2151) -- (3.375,1.1) -- (5.0917,1.1);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.5173) circle(0.05cm); 
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,2.4603) circle(0.05cm); 
