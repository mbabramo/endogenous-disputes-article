...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.5105) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.1) circle(0.05cm); 
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.1681) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.5912) -- (3.375,1.78) -- (5.0917,1.78);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.1017) -- (3.375,1.1) -- (5.0917,1.1);
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.3597) -- (3.375,1.1) -- (5.0917,1.1);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.6092) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.1126) circle(0.05cm); 
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.3752) circle(0.05cm); 
