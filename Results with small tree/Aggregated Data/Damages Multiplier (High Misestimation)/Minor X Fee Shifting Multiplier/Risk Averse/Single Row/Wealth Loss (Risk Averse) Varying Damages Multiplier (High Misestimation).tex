...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.9458) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.883) -- (3.375,2.8223) -- (5.0917,2.8072);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.278) circle(0.05cm); 
