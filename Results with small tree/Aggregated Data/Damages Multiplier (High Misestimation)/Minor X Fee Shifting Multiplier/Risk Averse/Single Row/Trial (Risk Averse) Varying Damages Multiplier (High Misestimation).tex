...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1131) -- (3.375,1.1) -- (5.0917,1.1);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1019) circle(0.05cm); 
