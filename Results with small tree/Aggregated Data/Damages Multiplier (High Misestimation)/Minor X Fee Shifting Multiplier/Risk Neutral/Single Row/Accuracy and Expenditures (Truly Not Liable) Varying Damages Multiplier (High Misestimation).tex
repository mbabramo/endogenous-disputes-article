...
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.1274) circle(0.05cm); 
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.1205) circle(0.05cm); 
...
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.1057) -- (3.375,1.1328) -- (5.0917,1.1063);
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.1062) -- (3.375,1.131) -- (5.0917,1.1076);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.6457) circle(0.05cm); 
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,2.5655) circle(0.05cm); 
