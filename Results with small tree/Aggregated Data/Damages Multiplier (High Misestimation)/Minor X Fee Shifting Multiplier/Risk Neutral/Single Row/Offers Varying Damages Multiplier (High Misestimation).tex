...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.6418) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.12) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.4799) -- (3.375,3.48) -- (5.0917,4.1599);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.4401) -- (3.375,2.709) -- (5.0917,2.3137);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.0878) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.7515) circle(0.05cm); 
