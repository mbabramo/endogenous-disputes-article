...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1142) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.0996) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.104) -- (3.375,1.1198) -- (5.0917,1.1103);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.2708) -- (3.375,1.3173) -- (5.0917,1.2877);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.8983) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.1496) circle(0.05cm); 
