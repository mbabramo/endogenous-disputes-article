...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.9426) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.9414) -- (3.375,2.9487) -- (5.0917,2.9422);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.3582) circle(0.05cm); 
