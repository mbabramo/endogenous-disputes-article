...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.6769) -- (3.375,2.6571) -- (5.0917,2.6769);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,4.3665) -- (3.375,4.3665) -- (5.0917,4.3665);
