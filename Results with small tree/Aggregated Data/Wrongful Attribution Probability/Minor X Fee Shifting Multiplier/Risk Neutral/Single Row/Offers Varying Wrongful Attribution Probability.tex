...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.0369) -- (3.375,3.48) -- (5.0917,3.3254);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.6953) -- (3.375,3.7554) -- (5.0917,2.8);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.44) -- (3.375,1.44) -- (5.0917,1.686);
