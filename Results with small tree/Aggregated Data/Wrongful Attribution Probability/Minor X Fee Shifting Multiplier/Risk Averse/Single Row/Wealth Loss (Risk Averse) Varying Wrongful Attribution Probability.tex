...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.6689) -- (3.375,2.6556) -- (5.0917,2.6373);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,4.3844) -- (3.375,4.3624) -- (5.0917,4.3844);
