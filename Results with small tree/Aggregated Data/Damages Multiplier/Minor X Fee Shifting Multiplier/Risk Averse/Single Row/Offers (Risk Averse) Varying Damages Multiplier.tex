...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,2.8) -- (2.6125,2.3184) -- (3.8208,1.44);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.4042,2.4739) -- (2.6125,1.4969) -- (3.8208,1.44);
