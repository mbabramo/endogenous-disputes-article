...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,3.1303) -- (2.6125,2.6367) -- (3.8208,2.6367);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,1.7553) -- (2.6125,2.1524) -- (3.8208,1.7632);
