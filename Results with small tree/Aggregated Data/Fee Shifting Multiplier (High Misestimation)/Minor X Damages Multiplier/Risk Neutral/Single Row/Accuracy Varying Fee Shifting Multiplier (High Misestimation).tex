...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1142) -- (3.375,1.104) -- (5.0917,2.8983);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.0996) -- (3.375,1.2708) -- (5.0917,1.1496);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.1198) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,1.3173) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.1103) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,1.2877) circle(0.05cm); 
