...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1103) -- (3.375,1.1104) -- (5.0917,1.6534);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.1262) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.1181) circle(0.05cm); 
