...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.5672) -- (3.375,2.5672) -- (5.0917,2.1474);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,2.198) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,2.8836) circle(0.05cm); 
