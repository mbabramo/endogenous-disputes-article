...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.6418) -- (3.375,3.4799) -- (5.0917,2.0878);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.12) -- (3.375,1.4401) -- (5.0917,1.7515);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,3.48) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,2.709) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,4.1599) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,2.3137) circle(0.05cm); 
