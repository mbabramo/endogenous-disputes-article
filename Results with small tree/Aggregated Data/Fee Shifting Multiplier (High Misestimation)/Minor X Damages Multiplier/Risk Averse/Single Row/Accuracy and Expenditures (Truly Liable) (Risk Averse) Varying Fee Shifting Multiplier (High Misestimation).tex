...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.1262) -- (3.375,2.328) -- (5.0917,2.373);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.1) -- (3.375,1.1043) -- (5.0917,1.1315);
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.2703) -- (3.375,1.7492) -- (5.0917,1.7881);
