...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.4692) -- (3.375,1.4566) -- (5.0917,1.5356);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.4445) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.4414) circle(0.05cm); 
