...
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.1074) -- (3.375,1.3983) -- (5.0917,3.9346);
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.1066) -- (3.375,1.3302) -- (5.0917,3.8206);
