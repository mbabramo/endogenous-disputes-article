...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.8158) -- (5.0917,2.1523);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,2.6546) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,3.1411) circle(0.05cm); 
