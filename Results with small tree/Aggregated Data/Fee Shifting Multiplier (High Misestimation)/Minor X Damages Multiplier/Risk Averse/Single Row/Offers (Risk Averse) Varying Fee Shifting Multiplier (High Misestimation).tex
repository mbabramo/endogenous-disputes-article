...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.8) -- (3.375,2.8) -- (5.0917,1.4422);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.8) -- (3.375,2.4225) -- (5.0917,1.4991);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.8697) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,1.6909) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,2.1184) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,1.8574) circle(0.05cm); 
