...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.2517,1.4029) -- (2.155,1.7169) -- (3.0583,1.7249);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.2517,1.2367) -- (2.155,1.1856) -- (3.0583,1.191);
\draw[green, opacity=0.70, line width=1mm, solid] (1.2517,1.2969) -- (2.155,1.192) -- (3.0583,1.1742);
