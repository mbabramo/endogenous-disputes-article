...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.2517,2.0032) -- (2.155,3.6295) -- (3.0583,3.5857);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.2517,2.486) -- (2.155,3.0546) -- (3.0583,3.0598);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.2517,2.1201) -- (2.155,1.6996) -- (3.0583,2.4802);
