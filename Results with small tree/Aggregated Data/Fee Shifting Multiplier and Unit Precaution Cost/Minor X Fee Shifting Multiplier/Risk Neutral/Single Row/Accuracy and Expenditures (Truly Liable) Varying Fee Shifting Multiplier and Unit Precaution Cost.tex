...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.2517,2.661) -- (2.155,2.7321) -- (3.0583,2.7532);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.2517,1.1373) -- (2.155,1.1484) -- (3.0583,1.1353);
\draw[green, opacity=0.70, line width=1mm, solid] (1.2517,1.542) -- (2.155,1.1611) -- (3.0583,1.1504);
