...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.12) -- (3.375,2.7153) -- (5.0917,1.44);
...
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,1.8136) circle(0.05cm); 
