...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.8404) -- (3.375,2.8462) -- (5.0917,3.2169);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.8115) -- (3.375,2.8345) -- (5.0917,2.8301);
