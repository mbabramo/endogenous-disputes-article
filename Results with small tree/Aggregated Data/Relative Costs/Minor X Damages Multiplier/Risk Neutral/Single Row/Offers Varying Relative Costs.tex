...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.4211) -- (3.375,3.5711) -- (5.0917,1.5361);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.6103) -- (3.375,3.48) -- (5.0917,3.9887);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.12) -- (3.375,2.9415) -- (5.0917,1.4402);
