...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.8462) -- (3.375,2.827) -- (5.0917,2.8314);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.8345) -- (3.375,2.8346) -- (5.0917,2.8301);
