...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.1622) -- (3.375,2.6367) -- (5.0917,3.1303);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.6367) -- (3.375,2.6367) -- (5.0917,2.6367);
