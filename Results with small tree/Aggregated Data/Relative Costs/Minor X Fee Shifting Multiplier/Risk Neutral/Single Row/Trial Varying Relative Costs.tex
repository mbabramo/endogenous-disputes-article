...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.2505) -- (3.375,1.1325) -- (5.0917,1.2211);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1318) -- (3.375,1.1318) -- (5.0917,1.1325);
