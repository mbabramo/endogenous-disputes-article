...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,1.7553) -- (2.6125,2.903) -- (3.8208,2.6546);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,3.133) -- (2.6125,2.2325) -- (3.8208,2.2325);
