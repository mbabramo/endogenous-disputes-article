...
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (1.2,1.592) rectangle (1.8725,2.354);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (1.8725,1.592) rectangle (2.916,2.608);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (2.916,1.592) rectangle (2.9185,1.592);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (2.916,1.592) rectangle (2.9185,1.7324);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (2.916,1.7324) rectangle (2.9185,1.8728);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (2.916,1.8728) rectangle (2.9185,2.1536);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (2.9185,1.592) rectangle (3.7249,1.592);
\draw[pattern=crosshatch dots, pattern color=yellow,draw=black,very thin] (2.9185,1.592) rectangle (3.7249,2.996);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (3.7249,1.592) rectangle (3.7444,1.592);
\draw[pattern=vertical lines, pattern color=orange,draw=black,very thin] (3.7249,1.592) rectangle (3.7444,2.996);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (3.7444,1.592) rectangle (4.6156,1.5921);
\draw[pattern=crosshatch dots, pattern color=yellow,draw=black,very thin] (3.7444,1.5921) rectangle (4.6156,2.996);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (4.6156,1.592) rectangle (4.6216,1.592);
\draw[pattern=crosshatch dots, pattern color=yellow,draw=black,very thin] (4.6156,1.592) rectangle (4.6216,2.996);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (4.6156,2.996) rectangle (4.6216,3.1364);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (4.6156,3.1364) rectangle (4.6216,3.2768);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (4.6156,3.2768) rectangle (4.6216,3.5576);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (4.6216,1.592) rectangle (4.6292,1.592);
\draw[pattern=vertical lines, pattern color=orange,draw=black,very thin] (4.6216,1.592) rectangle (4.6292,2.996);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (4.6216,2.996) rectangle (4.6292,3.1364);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (4.6216,3.1364) rectangle (4.6292,3.2768);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (4.6216,3.2768) rectangle (4.6292,3.5576);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (4.6292,1.592) rectangle (4.6313,1.592);
\draw[pattern=crosshatch dots, pattern color=yellow,draw=black,very thin] (4.6292,1.592) rectangle (4.6313,2.996);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (4.6292,2.996) rectangle (4.6313,3.1364);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (4.6292,3.1364) rectangle (4.6313,3.2768);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (4.6292,3.2768) rectangle (4.6313,3.5576);
\draw[pattern=grid,            pattern color=red!70!black,draw=black,very thin] (4.6292,3.5576) rectangle (4.6313,3.8384);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (4.6313,1.592) rectangle (4.632,1.592);
\draw[pattern=vertical lines, pattern color=orange,draw=black,very thin] (4.6313,1.592) rectangle (4.632,2.996);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (4.6313,2.996) rectangle (4.632,3.1364);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (4.6313,3.1364) rectangle (4.632,3.2768);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (4.6313,3.2768) rectangle (4.632,3.5576);
\draw[pattern=grid,            pattern color=red!70!black,draw=black,very thin] (4.6313,3.5576) rectangle (4.632,3.8384);
\node[font=\small,text=black,anchor=north] at (2.916, 4.4) {$9.1533\times 10^{-5}$};
...
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (5.082,1.592) rectangle (5.8159,2.354);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (5.8159,1.592) rectangle (6.798,2.608);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (6.798,1.592) rectangle (7.6569,1.592);
\draw[pattern=crosshatch dots, pattern color=yellow,draw=black,very thin] (6.798,1.592) rectangle (7.6569,3.0006);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (7.6569,1.592) rectangle (7.7045,1.592);
\draw[pattern=vertical lines, pattern color=orange,draw=black,very thin] (7.6569,1.592) rectangle (7.7045,3.0006);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (7.7045,1.592) rectangle (8.514,1.5921);
\draw[pattern=crosshatch dots, pattern color=yellow,draw=black,very thin] (7.7045,1.5921) rectangle (8.514,3.0006);
\node[font=\small,text=black,anchor=north] at (6.798, 4.4) {$9.1172\times 10^{-5}$};
...
\draw[black,very thin] (8.464,3.0005) -- (8.564,3.0005);
\node[font=\small,text=black, anchor=east] at (8.464, 3.0005) {\contour{white}{}};
...
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (14.562,1.592) rectangle (15.685,1.592);
\draw[pattern=crosshatch dots, pattern color=yellow,draw=black,very thin] (14.562,1.592) rectangle (15.685,3.127);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (15.685,1.592) rectangle (16.278,1.592);
\draw[pattern=vertical lines, pattern color=orange,draw=black,very thin] (15.685,1.592) rectangle (16.278,3.127);
...
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (18.444,1.592) rectangle (19.567,1.592);
\draw[pattern=crosshatch dots, pattern color=yellow,draw=black,very thin] (18.444,1.592) rectangle (19.567,3.127);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (19.567,1.592) rectangle (20.16,1.592);
\draw[pattern=vertical lines, pattern color=orange,draw=black,very thin] (19.567,1.592) rectangle (20.16,3.127);
\node[font=\small,text=black,anchor=north] at (18.444, 4.4) {$9.0427\times 10^{-5}$};
...
\draw[black,very thin] (20.11,3.127) -- (20.21,3.127);
\node[font=\small,text=black, anchor=east] at (20.11, 3.127) {\contour{white}{}};
