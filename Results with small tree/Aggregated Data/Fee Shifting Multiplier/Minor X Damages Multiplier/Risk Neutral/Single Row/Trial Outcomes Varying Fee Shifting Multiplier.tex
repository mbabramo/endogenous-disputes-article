...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.2517,3.0951) -- (2.155,2.6367) -- (3.0583,2.1622);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.2517,2.6367) -- (2.155,2.1622) -- (3.0583,2.1622);
