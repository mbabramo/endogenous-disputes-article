...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.2517,1.3601) -- (2.155,1.2608) -- (3.0583,1.1494);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.2517,1.1717) -- (2.155,1.1269) -- (3.0583,2.4638);
\draw[green, opacity=0.70, line width=1mm, solid] (1.2517,1.2679) -- (2.155,1.1253) -- (3.0583,2.4665);
