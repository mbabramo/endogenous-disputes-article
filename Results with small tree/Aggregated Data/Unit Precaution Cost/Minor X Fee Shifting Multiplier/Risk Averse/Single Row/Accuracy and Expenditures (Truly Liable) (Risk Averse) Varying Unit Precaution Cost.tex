...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,4.0041) -- (2.6125,3.7164) -- (3.8208,4.5);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.4042,1.1145) -- (2.6125,1.3177) -- (3.8208,1.1);
\draw[green, opacity=0.70, line width=1mm, solid] (1.4042,1.5259) -- (2.6125,1.5259) -- (3.8208,1.1);
