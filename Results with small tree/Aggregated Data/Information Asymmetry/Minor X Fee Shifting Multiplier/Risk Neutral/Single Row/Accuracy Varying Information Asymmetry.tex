...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.2149) -- (3.375,1.1773) -- (5.0917,1.1742);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.2756) -- (3.375,1.2559) -- (5.0917,1.8665);
