...
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (1.5556,1.54) rectangle (4.21,2.2612);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (4.21,1.54) rectangle (4.6299,1.54);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (4.21,1.54) rectangle (4.6299,1.5685);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (4.21,1.5685) rectangle (4.6299,1.597);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (4.21,1.597) rectangle (4.6299,1.654);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (4.6299,1.54) rectangle (6.8644,1.54);
\draw[pattern=crosshatch dots, pattern color=yellow,draw=black,very thin] (4.6299,1.54) rectangle (6.8644,2.6798);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (4.6299,2.6798) rectangle (6.8644,2.7083);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (4.6299,2.7083) rectangle (6.8644,2.7368);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (4.6299,2.7368) rectangle (6.8644,2.7938);
\node[font=\small,text=black,anchor=north] at (4.21, 3.5333) {Total: $9.9528\times 10^{-5}$};
...
\draw[black,very thin] (6.8144,2.6798) -- (6.9144,2.6798);
\node[font=\small,text=black, anchor=east] at (6.8144, 2.6798) {\contour{white}{}};
...
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (14.496,1.54) rectangle (15.149,1.9006);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (15.149,1.54) rectangle (16.203,2.0809);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (16.203,1.54) rectangle (17.15,2.2612);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (17.15,1.54) rectangle (17.239,1.54);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (17.15,1.54) rectangle (17.239,1.5709);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (17.15,1.5709) rectangle (17.239,1.6019);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (17.15,1.6019) rectangle (17.239,1.6637);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (17.239,1.54) rectangle (17.393,1.54);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (17.239,1.54) rectangle (17.393,1.571);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (17.239,1.571) rectangle (17.393,1.6019);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (17.239,1.6019) rectangle (17.393,1.6637);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (17.393,1.54) rectangle (17.531,1.54);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (17.393,1.54) rectangle (17.531,1.571);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (17.393,1.571) rectangle (17.531,1.6019);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (17.393,1.6019) rectangle (17.531,1.6637);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (17.531,1.54) rectangle (17.537,1.54);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (17.531,1.54) rectangle (17.537,1.5709);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (17.531,1.5709) rectangle (17.537,1.6019);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (17.531,1.6019) rectangle (17.537,1.6637);
\draw[pattern=grid,            pattern color=red!70!black,draw=black,very thin] (17.531,1.6637) rectangle (17.537,1.7255);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (17.537,1.54) rectangle (18.233,1.54);
\draw[pattern=crosshatch dots, pattern color=yellow,draw=black,very thin] (17.537,1.54) rectangle (18.233,2.7767);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (17.537,2.7767) rectangle (18.233,2.8076);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (17.537,2.8076) rectangle (18.233,2.8385);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (17.537,2.8385) rectangle (18.233,2.9003);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (18.233,1.54) rectangle (18.247,1.54);
\draw[pattern=vertical lines, pattern color=orange,draw=black,very thin] (18.233,1.54) rectangle (18.247,2.7767);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (18.233,2.7767) rectangle (18.247,2.8076);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (18.233,2.8076) rectangle (18.247,2.8385);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (18.233,2.8385) rectangle (18.247,2.9003);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (18.247,1.54) rectangle (19.065,1.54);
\draw[pattern=crosshatch dots, pattern color=yellow,draw=black,very thin] (18.247,1.54) rectangle (19.065,2.7767);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (18.247,2.7767) rectangle (19.065,2.8076);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (18.247,2.8076) rectangle (19.065,2.8385);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (18.247,2.8385) rectangle (19.065,2.9004);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (19.065,1.54) rectangle (19.204,1.54);
\draw[pattern=vertical lines, pattern color=orange,draw=black,very thin] (19.065,1.54) rectangle (19.204,2.7767);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (19.065,2.7767) rectangle (19.204,2.8076);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (19.065,2.8076) rectangle (19.204,2.8385);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (19.065,2.8385) rectangle (19.204,2.9004);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (19.204,1.54) rectangle (19.758,1.54);
\draw[pattern=crosshatch dots, pattern color=yellow,draw=black,very thin] (19.204,1.54) rectangle (19.758,2.7767);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (19.204,2.7767) rectangle (19.758,2.8076);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (19.204,2.8076) rectangle (19.758,2.8385);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (19.204,2.8385) rectangle (19.758,2.9004);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (19.758,1.54) rectangle (19.802,1.54);
\draw[pattern=crosshatch dots, pattern color=yellow,draw=black,very thin] (19.758,1.54) rectangle (19.802,2.7767);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (19.758,2.7767) rectangle (19.802,2.8076);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (19.758,2.8076) rectangle (19.802,2.8385);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (19.758,2.8385) rectangle (19.802,2.9003);
\draw[pattern=grid,            pattern color=red!70!black,draw=black,very thin] (19.758,2.9003) rectangle (19.802,2.9622);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (19.802,1.54) rectangle (19.804,1.54);
\draw[pattern=vertical lines, pattern color=orange,draw=black,very thin] (19.802,1.54) rectangle (19.804,2.7767);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (19.802,2.7767) rectangle (19.804,2.8076);
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (19.802,2.8076) rectangle (19.804,2.8385);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (19.802,2.8385) rectangle (19.804,2.9003);
\draw[pattern=grid,            pattern color=red!70!black,draw=black,very thin] (19.802,2.9003) rectangle (19.804,2.9622);
\node[font=\small,text=black,anchor=north] at (17.15, 3.5333) {Total: $9.6612\times 10^{-5}$};
...
\draw[black,very thin] (19.754,2.7767) -- (19.854,2.7767);
\node[font=\small,text=black, anchor=east] at (19.754, 2.7767) {\contour{white}{1}};
...
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (1.5556,4.3733) rectangle (4.21,5.0946);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (4.21,4.3733) rectangle (6.8644,4.3734);
\draw[pattern=crosshatch dots, pattern color=yellow,draw=black,very thin] (4.21,4.3734) rectangle (6.8644,5.3328);
...
\draw[black,very thin] (6.8144,6.2922) -- (6.9144,6.2922);
\node[font=\small,text=black, anchor=east] at (6.8144, 6.2922) {\contour{white}{2}};
...
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (17.15,4.3733) rectangle (18.913,4.3734);
\draw[pattern=crosshatch dots, pattern color=yellow,draw=black,very thin] (17.15,4.3734) rectangle (18.913,5.463);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (18.913,4.3733) rectangle (19.804,4.3734);
\draw[pattern=vertical lines, pattern color=orange,draw=black,very thin] (18.913,4.3734) rectangle (19.804,5.463);
\node[font=\small,text=black,anchor=north] at (17.15, 6.3667) {Total: $9.0426\times 10^{-5}$};
...
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (17.15,7.2067) rectangle (18.338,7.2067);
\draw[pattern=crosshatch dots, pattern color=yellow,draw=black,very thin] (17.15,7.2067) rectangle (18.338,8.4841);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (18.338,7.2067) rectangle (19.804,7.2067);
\draw[pattern=vertical lines, pattern color=orange,draw=black,very thin] (18.338,7.2067) rectangle (19.804,8.4841);
\node[font=\small,text=black,anchor=north] at (17.15, 9.2) {Total: $9.0838\times 10^{-5}$};
