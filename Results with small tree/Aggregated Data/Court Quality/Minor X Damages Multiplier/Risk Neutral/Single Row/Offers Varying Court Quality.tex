...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.3727) -- (3.375,4.16) -- (5.0917,1.6244);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.6735) -- (3.375,2.12) -- (5.0917,1.5016);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.6735) -- (3.375,1.957) -- (5.0917,1.44);
