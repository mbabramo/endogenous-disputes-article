...
\draw[fill=green!85,draw=white,very thin] (1.5,2.5) rectangle (6.1371,5.4851);
\draw[fill=green!85,draw=white,very thin] (6.1371,2.5) rectangle (13.333,6.4802);
\draw[fill=green!85,draw=white,very thin] (13.333,2.5) rectangle (13.35,2.5002);
\draw[fill=blue!30,draw=white,very thin] (13.333,2.5002) rectangle (13.35,3.0502);
\draw[fill=blue!60,draw=white,very thin] (13.333,3.0502) rectangle (13.35,3.6001);
\draw[fill=blue!90,draw=white,very thin] (13.333,3.6001) rectangle (13.35,4.7001);
\draw[fill=green!85,draw=white,very thin] (13.35,2.5) rectangle (18.911,2.5002);
\draw[fill=yellow!85,draw=white,very thin] (13.35,2.5002) rectangle (18.911,8.0001);
\draw[fill=green!85,draw=white,very thin] (18.911,2.5) rectangle (19.046,2.5002);
\draw[fill=orange!85,draw=white,very thin] (18.911,2.5002) rectangle (19.046,8.0001);
\draw[fill=green!85,draw=white,very thin] (19.046,2.5) rectangle (25.053,2.5002);
\draw[fill=yellow!85,draw=white,very thin] (19.046,2.5002) rectangle (25.053,8.0001);
\draw[fill=green!85,draw=white,very thin] (25.053,2.5) rectangle (25.095,2.5002);
\draw[fill=yellow!85,draw=white,very thin] (25.053,2.5002) rectangle (25.095,8.0001);
\draw[fill=blue!30,draw=white,very thin] (25.053,8.0001) rectangle (25.095,8.5501);
\draw[fill=blue!60,draw=white,very thin] (25.053,8.5501) rectangle (25.095,9.1);
\draw[fill=blue!90,draw=white,very thin] (25.053,9.1) rectangle (25.095,10.2);
\draw[fill=green!85,draw=white,very thin] (25.095,2.5) rectangle (25.148,2.5002);
\draw[fill=orange!85,draw=white,very thin] (25.095,2.5002) rectangle (25.148,8.0001);
\draw[fill=blue!30,draw=white,very thin] (25.095,8.0001) rectangle (25.148,8.5501);
\draw[fill=blue!60,draw=white,very thin] (25.095,8.5501) rectangle (25.148,9.1);
\draw[fill=blue!90,draw=white,very thin] (25.095,9.1) rectangle (25.148,10.2);
