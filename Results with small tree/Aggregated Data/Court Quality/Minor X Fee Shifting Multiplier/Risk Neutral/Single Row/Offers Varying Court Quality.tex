...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,4.16) -- (3.375,2.5941) -- (5.0917,3.8316);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.12) -- (3.375,2.12) -- (5.0917,1.6797);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.957) -- (3.375,1.8558) -- (5.0917,1.44);
