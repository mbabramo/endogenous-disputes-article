...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.8402) -- (3.375,2.8375) -- (5.0917,2.8261);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.8436) -- (3.375,2.8568) -- (5.0917,2.8072);
