...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.2499) -- (3.375,1.1664) -- (5.0917,1.1664);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1361) -- (3.375,1.2177) -- (5.0917,1.1);
