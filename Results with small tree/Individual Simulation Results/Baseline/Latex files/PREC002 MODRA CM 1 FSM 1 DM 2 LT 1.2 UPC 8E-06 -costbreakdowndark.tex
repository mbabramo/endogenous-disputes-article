...
\draw[fill=green!85,draw=white,very thin] (1.5,2.5) rectangle (6.1372,3.5138);
\draw[fill=green!85,draw=white,very thin] (6.1372,2.5) rectangle (13.333,3.8517);
...
\draw[fill=green!85,draw=white,very thin] (15.182,2.5) rectangle (15.229,2.5001);
\draw[fill=orange!85,draw=white,very thin] (15.182,2.5001) rectangle (15.229,5.2501);
\draw[fill=green!85,draw=white,very thin] (15.229,2.5) rectangle (19.954,2.5001);
\draw[fill=yellow!85,draw=white,very thin] (15.229,2.5001) rectangle (19.954,5.2501);
\draw[fill=blue!30,draw=white,very thin] (15.229,5.2501) rectangle (19.954,5.5251);
\draw[fill=blue!60,draw=white,very thin] (15.229,5.5251) rectangle (19.954,5.8001);
\draw[fill=blue!90,draw=white,very thin] (15.229,5.8001) rectangle (19.954,6.3501);
\draw[fill=green!85,draw=white,very thin] (19.954,2.5) rectangle (20.066,2.5001);
\draw[fill=orange!85,draw=white,very thin] (19.954,2.5001) rectangle (20.066,5.2501);
\draw[fill=blue!30,draw=white,very thin] (19.954,5.2501) rectangle (20.066,5.5251);
\draw[fill=blue!60,draw=white,very thin] (19.954,5.5251) rectangle (20.066,5.8001);
\draw[fill=blue!90,draw=white,very thin] (19.954,5.8001) rectangle (20.066,6.3501);
...
\node[font=\small,rotate=90,text=white, anchor=center] at (1.1, 8.836) {Cost};
\draw[white,very thin] (1.45,2.5) -- (1.55,2.5);
\node[font=\small,text=white, anchor=east] at (1.45, 2.5) {0};
\draw[white,very thin] (1.45,6.724) -- (1.55,6.724);
\node[font=\small,text=white, anchor=east] at (1.45, 6.724) {$\frac{1}{10^{4}}$};
