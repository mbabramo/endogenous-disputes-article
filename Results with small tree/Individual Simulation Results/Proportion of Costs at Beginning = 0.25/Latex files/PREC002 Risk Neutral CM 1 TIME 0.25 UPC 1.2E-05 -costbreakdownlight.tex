...
\begin{document}
\begin{tikzpicture}
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (1.5,2.5) rectangle (2.5572,3.6805);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (2.5572,2.5) rectangle (6.4428,4.2707);
\draw[pattern=crosshatch, pattern color=green,draw=black,very thin] (6.4428,2.5) rectangle (7.5,4.8609);
...
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (7.5,2.6501) rectangle (7.5621,2.8001);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (7.5,2.8001) rectangle (7.5621,3.4001);
...
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (7.5621,2.6501) rectangle (7.5713,2.8001);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (7.5621,2.8001) rectangle (7.5713,3.4001);
\draw[pattern=grid,            pattern color=red!70!black,draw=black,very thin] (7.5621,3.4001) rectangle (7.5713,4.3001);
...
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (7.5713,2.6501) rectangle (7.6068,2.8001);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (7.5713,2.8001) rectangle (7.6068,3.4001);
\draw[pattern=grid,            pattern color=red!70!black,draw=black,very thin] (7.5713,3.4001) rectangle (7.6068,4.3001);
...
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (12.938,5.6501) rectangle (13.041,5.8001);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (12.938,5.8001) rectangle (13.041,6.4001);
...
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (13.041,5.6501) rectangle (13.245,5.8001);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (13.041,5.8001) rectangle (13.245,6.4001);
...
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (13.245,5.6501) rectangle (13.306,5.8001);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (13.245,5.8001) rectangle (13.306,6.4001);
\draw[pattern=grid,            pattern color=red!70!black,draw=black,very thin] (13.245,6.4001) rectangle (13.306,7.3001);
...
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (13.306,5.6501) rectangle (13.312,5.8001);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (13.306,5.8001) rectangle (13.312,6.4001);
\draw[pattern=grid,            pattern color=red!70!black,draw=black,very thin] (13.306,6.4001) rectangle (13.312,7.3001);
...
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (13.312,5.6501) rectangle (13.439,5.8001);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (13.312,5.8001) rectangle (13.439,6.4001);
\draw[pattern=grid,            pattern color=red!70!black,draw=black,very thin] (13.312,6.4001) rectangle (13.439,7.3001);
...
\draw[pattern=dots,  pattern color=blue!60,draw=black,very thin] (13.439,5.6501) rectangle (13.5,5.8001);
\draw[pattern=crosshatch,      pattern color=blue!90,draw=black,very thin] (13.439,5.8001) rectangle (13.5,6.4001);
\draw[pattern=grid,            pattern color=red!70!black,draw=black,very thin] (13.439,6.4001) rectangle (13.5,7.3001);
