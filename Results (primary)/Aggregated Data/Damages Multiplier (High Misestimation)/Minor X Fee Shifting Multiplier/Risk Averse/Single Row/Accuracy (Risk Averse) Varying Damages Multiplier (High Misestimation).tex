...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.2838) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.1295) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.3746) -- (3.375,1.1204) -- (5.0917,1.1);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.2465) -- (3.375,1.9481) -- (5.0917,2.7995);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.3061) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.4848) circle(0.05cm); 
