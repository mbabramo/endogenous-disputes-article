...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.9577) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.7536) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.5395) -- (3.375,3.2907);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.2962) -- (3.375,2.3092);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.44) circle(0.05cm); 
