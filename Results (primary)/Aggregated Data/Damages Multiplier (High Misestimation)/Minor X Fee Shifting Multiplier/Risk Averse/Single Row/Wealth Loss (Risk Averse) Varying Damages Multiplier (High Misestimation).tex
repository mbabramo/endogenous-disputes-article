...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.1515) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.1148) -- (3.375,2.9781) -- (5.0917,2.97);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.6043) circle(0.05cm); 
