...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1604) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1758) -- (3.375,1.1024) -- (5.0917,1.1);
