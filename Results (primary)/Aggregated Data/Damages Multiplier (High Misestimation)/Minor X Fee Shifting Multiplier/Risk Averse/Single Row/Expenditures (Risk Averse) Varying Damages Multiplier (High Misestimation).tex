...
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.8325) circle(0.05cm); 
...
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.6217) -- (3.375,1.1542) -- (5.0917,1.1);
...
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,3.82) circle(0.05cm); 
