...
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.3789) circle(0.05cm); 
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.3576) circle(0.05cm); 
...
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.3886) -- (3.375,1.1245) -- (5.0917,1.1);
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.3175) -- (3.375,1.1209) -- (5.0917,1.1);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.46) circle(0.05cm); 
