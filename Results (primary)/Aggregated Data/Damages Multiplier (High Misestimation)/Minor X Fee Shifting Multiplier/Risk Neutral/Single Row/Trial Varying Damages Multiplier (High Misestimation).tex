...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.2043) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.5064) -- (3.375,1.6083) -- (5.0917,1.4468);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.532) circle(0.05cm); 
