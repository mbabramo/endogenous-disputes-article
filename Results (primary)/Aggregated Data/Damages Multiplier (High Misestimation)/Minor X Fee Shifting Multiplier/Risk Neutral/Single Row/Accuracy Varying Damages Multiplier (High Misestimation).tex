...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.2919) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.8387) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.6089) -- (3.375,1.4634) -- (5.0917,1.4134);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.4969) -- (3.375,1.5269) -- (5.0917,1.5176);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.2744) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.3547) circle(0.05cm); 
