...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.1342) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.317) -- (3.375,3.17) -- (5.0917,3.1231);
