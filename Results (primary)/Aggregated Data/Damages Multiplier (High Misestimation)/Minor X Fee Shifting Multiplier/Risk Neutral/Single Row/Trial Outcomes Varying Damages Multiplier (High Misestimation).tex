...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.0356) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.7585) -- (3.375,2.6891) -- (5.0917,2.6344);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.8012) circle(0.05cm); 
