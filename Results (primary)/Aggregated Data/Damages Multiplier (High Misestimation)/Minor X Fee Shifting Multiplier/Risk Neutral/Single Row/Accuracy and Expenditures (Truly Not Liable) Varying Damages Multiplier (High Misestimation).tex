...
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.3644) circle(0.05cm); 
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.3642) circle(0.05cm); 
...
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.6982) -- (3.375,1.4978) -- (5.0917,1.4332);
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.5861) -- (3.375,1.441) -- (5.0917,1.3756);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,3.0289) circle(0.05cm); 
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,2.6517) circle(0.05cm); 
