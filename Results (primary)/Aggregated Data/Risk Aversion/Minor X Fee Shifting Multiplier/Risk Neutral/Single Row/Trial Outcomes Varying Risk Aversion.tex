...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,1.7638) -- (2.6125,2.6176) -- (3.8208,2.9081);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,2.6951) -- (2.6125,2.9093) -- (3.8208,3.0771);
