...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,2.7996) -- (2.6125,2.7889) -- (3.8208,2.8);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.4042,1.1) -- (2.6125,1.1008) -- (3.8208,1.1);
\draw[green, opacity=0.70, line width=1mm, solid] (1.4042,1.1016) -- (2.6125,1.1422) -- (3.8208,1.1);
