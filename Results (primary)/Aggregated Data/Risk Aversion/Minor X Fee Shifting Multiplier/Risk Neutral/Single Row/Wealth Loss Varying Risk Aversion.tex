...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,3.0027) -- (2.6125,2.9782) -- (3.8208,2.9585);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,2.9799) -- (2.6125,2.9664) -- (3.8208,2.9664);
