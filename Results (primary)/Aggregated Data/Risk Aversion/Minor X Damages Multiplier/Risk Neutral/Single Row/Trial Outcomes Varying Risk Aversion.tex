...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,2.7873) -- (2.6125,1.7638) -- (3.8208,1.5464);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.4042,2.7252) -- (2.6125,2.6951) -- (3.8208,2.1463);
