...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.0452) -- (3.375,2.9599) -- (5.0917,2.9664);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.9674) -- (3.375,2.9664) -- (5.0917,2.9799);
