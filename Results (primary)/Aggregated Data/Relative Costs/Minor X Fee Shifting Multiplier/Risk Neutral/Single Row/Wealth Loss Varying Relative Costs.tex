...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.1327) -- (3.375,3.0558) -- (5.0917,3.0266);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.005) -- (3.375,2.9995) -- (5.0917,3.0316);
