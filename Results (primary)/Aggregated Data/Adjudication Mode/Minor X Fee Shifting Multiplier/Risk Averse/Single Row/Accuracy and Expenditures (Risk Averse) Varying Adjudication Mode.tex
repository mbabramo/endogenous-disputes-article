...
\draw[blue, opacity=0.70, line width=0.5mm, double] (2.1667,1.9053) -- (4.9,2.0271) -- (7.6333,2.3676);
\draw[orange, opacity=0.70, line width=1mm, dashed] (2.1667,1.1322) -- (4.9,1.1303) -- (7.6333,1.1);
\draw[green, opacity=0.70, line width=1mm, solid] (2.1667,1.2315) -- (4.9,1.1313) -- (7.6333,1.1);
