...
\draw[blue, opacity=0.70, line width=0.5mm, double] (2.1667,2.1625) -- (4.9,3.359) -- (7.6333,1.8638);
\draw[orange, opacity=0.70, line width=1mm, dashed] (2.1667,2.1605) -- (4.9,1.3125) -- (7.6333,1.6296);
