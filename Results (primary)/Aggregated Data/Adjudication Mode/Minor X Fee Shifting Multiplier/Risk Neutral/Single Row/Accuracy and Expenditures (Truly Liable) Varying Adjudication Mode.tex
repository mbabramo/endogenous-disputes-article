...
\draw[blue, opacity=0.70, line width=0.5mm, double] (2.1667,2.6135) -- (4.9,2.7618) -- (7.6333,2.7207);
\draw[orange, opacity=0.70, line width=1mm, dashed] (2.1667,1.1059) -- (4.9,1.1526) -- (7.6333,1.1808);
\draw[green, opacity=0.70, line width=1mm, solid] (2.1667,1.7661) -- (4.9,1.2021) -- (7.6333,1.2467);
