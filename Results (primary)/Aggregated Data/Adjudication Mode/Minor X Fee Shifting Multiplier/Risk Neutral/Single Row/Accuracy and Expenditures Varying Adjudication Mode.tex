...
\draw[blue, opacity=0.70, line width=0.5mm, double] (2.1667,1.135) -- (4.9,1.5242) -- (7.6333,1.631);
\draw[orange, opacity=0.70, line width=1mm, dashed] (2.1667,1.3083) -- (4.9,1.1861) -- (7.6333,1.1909);
\draw[green, opacity=0.70, line width=1mm, solid] (2.1667,1.302) -- (4.9,1.2031) -- (7.6333,1.1922);
