...
\draw[blue, opacity=0.70, line width=0.5mm, double] (2.1667,2.1625) -- (4.9,2.8705) -- (7.6333,3.1107);
\draw[orange, opacity=0.70, line width=1mm, dashed] (2.1667,1.9805) -- (4.9,1.4802) -- (7.6333,2.3597);
