...
\draw[blue, opacity=0.70, line width=0.5mm, double] (2.1667,2.4142) -- (4.9,2.1625) -- (7.6333,2.2077);
\draw[orange, opacity=0.70, line width=1mm, dashed] (2.1667,2.2452) -- (4.9,2.1605) -- (7.6333,2.2929);
