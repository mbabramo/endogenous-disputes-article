...
\draw[blue, opacity=0.70, line width=0.5mm, double] (2.1667,2.5875) -- (4.9,2.1625) -- (7.6333,1.7375);
\draw[orange, opacity=0.70, line width=1mm, dashed] (2.1667,2.4584) -- (4.9,1.9805) -- (7.6333,1.5582);
