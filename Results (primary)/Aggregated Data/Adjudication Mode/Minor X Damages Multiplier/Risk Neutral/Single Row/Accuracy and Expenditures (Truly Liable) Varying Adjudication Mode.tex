...
\draw[blue, opacity=0.70, line width=0.5mm, double] (2.1667,2.7978) -- (4.9,2.6135) -- (7.6333,2.5121);
\draw[orange, opacity=0.70, line width=1mm, dashed] (2.1667,1.1) -- (4.9,1.1059) -- (7.6333,1.1694);
\draw[green, opacity=0.70, line width=1mm, solid] (2.1667,1.1506) -- (4.9,1.7661) -- (7.6333,1.8069);
