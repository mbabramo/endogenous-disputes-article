...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.7626) -- (3.375,2.301) -- (5.0917,2.7238);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.1583) -- (3.375,2.8592) -- (5.0917,2.6804);
