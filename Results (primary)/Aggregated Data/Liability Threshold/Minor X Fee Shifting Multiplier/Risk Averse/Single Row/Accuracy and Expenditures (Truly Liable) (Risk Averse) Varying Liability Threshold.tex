...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.2517,4.3784) -- (2.155,4.3253) -- (3.0583,4.5);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.2517,1.1) -- (2.155,1.1438) -- (3.0583,1.1);
\draw[green, opacity=0.70, line width=1mm, solid] (1.2517,1.5325) -- (2.155,1.1876) -- (3.0583,1.1);
