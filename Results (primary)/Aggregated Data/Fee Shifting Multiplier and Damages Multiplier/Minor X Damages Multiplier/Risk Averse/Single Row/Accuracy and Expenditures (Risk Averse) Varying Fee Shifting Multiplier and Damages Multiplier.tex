...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.2517,1.9647) -- (2.155,1.631) -- (3.0583,1.1459);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.2517,1.1721) -- (2.155,1.1909) -- (3.0583,1.2837);
\draw[green, opacity=0.70, line width=1mm, solid] (1.2517,1.1677) -- (2.155,1.1922) -- (3.0583,1.2415);
