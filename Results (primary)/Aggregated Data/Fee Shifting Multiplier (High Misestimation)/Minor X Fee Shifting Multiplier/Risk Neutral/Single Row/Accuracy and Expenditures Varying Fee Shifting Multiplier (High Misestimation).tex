...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.8938) -- (3.375,1.9537) -- (5.0917,1.9352);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.1178) -- (3.375,1.8269) -- (5.0917,1.7267);
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,2.5072) -- (3.375,1.9374) -- (5.0917,1.7582);
