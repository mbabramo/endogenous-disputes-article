...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.9206) -- (3.375,1.9059) -- (5.0917,2.1017);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.8513) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.848) circle(0.05cm); 
