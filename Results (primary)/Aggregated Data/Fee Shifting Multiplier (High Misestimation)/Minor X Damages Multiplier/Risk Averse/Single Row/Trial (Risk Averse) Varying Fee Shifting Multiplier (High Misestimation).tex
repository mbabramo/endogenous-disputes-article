...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.1604) -- (3.375,1.1758) -- (5.0917,1.1);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.1024) circle(0.05cm); 
