...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.1342) -- (3.375,3.317) -- (5.0917,3.7411);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,3.17) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,3.1231) circle(0.05cm); 
