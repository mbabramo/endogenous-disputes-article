...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,3.0356) -- (3.375,2.7585) -- (5.0917,2.8012);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,2.6891) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,2.6344) circle(0.05cm); 
