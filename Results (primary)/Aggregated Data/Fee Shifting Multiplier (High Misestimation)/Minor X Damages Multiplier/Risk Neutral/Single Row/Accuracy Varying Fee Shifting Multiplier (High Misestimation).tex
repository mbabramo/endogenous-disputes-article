...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.196) -- (3.375,1.3545) -- (5.0917,2.1872);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.4693) -- (3.375,1.2984) -- (5.0917,1.2274);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.2817) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,1.3134) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.2567) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,1.3088) circle(0.05cm); 
