...
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.7723) -- (3.375,2.5072) -- (5.0917,4.3928);
...
\draw[green, opacity=0.70, line width=1mm, solid] (3.375,1.9374) circle(0.05cm); 
...
\draw[green, opacity=0.70, line width=1mm, solid] (3.375,1.7582) circle(0.05cm); 
