...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,2.423) -- (3.375,2.8654) -- (5.0917,2.3966);
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,2.4364) -- (3.375,2.5807) -- (5.0917,1.7859);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,3.0809) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,1.9068) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,2.7788) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,1.4953) circle(0.05cm); 
