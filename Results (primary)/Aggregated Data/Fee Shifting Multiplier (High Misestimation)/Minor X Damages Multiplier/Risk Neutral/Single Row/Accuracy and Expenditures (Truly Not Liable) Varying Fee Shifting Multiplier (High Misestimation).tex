...
\draw[orange, opacity=0.70, line width=1mm, dashed] (1.6583,1.2322) -- (3.375,1.3991) -- (5.0917,2.0644);
\draw[green, opacity=0.70, line width=1mm, solid] (1.6583,1.2321) -- (3.375,1.343) -- (5.0917,1.8759);
...
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,1.2989) circle(0.05cm); 
\draw[green, opacity=0.70, line width=1mm, solid] (3.375,1.2705) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.1) circle(0.05cm); 
\draw[orange, opacity=0.70, line width=1mm, dashed] (3.375,1.2666) circle(0.05cm); 
\draw[green, opacity=0.70, line width=1mm, solid] (3.375,1.2378) circle(0.05cm); 
