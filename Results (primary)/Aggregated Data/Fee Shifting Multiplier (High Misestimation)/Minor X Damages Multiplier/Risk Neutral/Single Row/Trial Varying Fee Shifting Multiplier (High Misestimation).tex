...
\draw[blue, opacity=0.70, line width=0.5mm, double] (1.6583,1.2043) -- (3.375,1.5064) -- (5.0917,2.532);
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.6083) circle(0.05cm); 
...
\draw[blue, opacity=0.70, line width=0.5mm, double] (3.375,1.4468) circle(0.05cm); 
