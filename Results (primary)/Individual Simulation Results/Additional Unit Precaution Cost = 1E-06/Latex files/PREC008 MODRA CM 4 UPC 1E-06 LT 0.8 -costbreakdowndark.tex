...
\draw[fill=green!85,draw=white,very thin] (13.333,2.5) rectangle (15.26,2.5);
\draw[fill=blue!30,draw=white,very thin] (13.333,2.5) rectangle (15.26,3.6);
\draw[fill=green!85,draw=white,very thin] (15.26,2.5) rectangle (18.797,2.5);
\draw[fill=yellow!85,draw=white,very thin] (15.26,2.5) rectangle (18.797,5.25);
\draw[fill=blue!30,draw=white,very thin] (15.26,5.25) rectangle (18.797,6.35);
\draw[fill=green!85,draw=white,very thin] (18.797,2.5) rectangle (25.167,2.5);
\draw[fill=orange!85,draw=white,very thin] (18.797,2.5) rectangle (25.167,5.25);
\draw[fill=blue!30,draw=white,very thin] (18.797,5.25) rectangle (25.167,6.35);
