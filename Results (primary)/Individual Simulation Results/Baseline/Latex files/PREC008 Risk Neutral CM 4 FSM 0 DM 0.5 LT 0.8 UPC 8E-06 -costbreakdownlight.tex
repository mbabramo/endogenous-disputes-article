...
\draw[pattern=crosshatch dots, pattern color=yellow,draw=black,very thin] (8.0454,2.5) rectangle (8.7873,5.5);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (8.0454,5.5) rectangle (8.7873,6.7);
\draw[pattern=vertical lines, pattern color=orange,draw=black,very thin] (8.7873,2.5) rectangle (13.5,5.5);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (8.7873,5.5) rectangle (13.5,6.7);
