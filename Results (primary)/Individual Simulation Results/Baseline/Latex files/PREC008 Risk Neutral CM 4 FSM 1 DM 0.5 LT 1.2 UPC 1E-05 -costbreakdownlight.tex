...
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (8.0454,5.5) rectangle (12.066,6.7);
\draw[pattern=vertical lines, pattern color=orange,draw=black,very thin] (12.066,2.5) rectangle (13.5,5.5);
\draw[pattern=north east lines, pattern color=blue!30,draw=black,very thin] (12.066,5.5) rectangle (13.5,6.7);
